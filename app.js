const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.27.2200",
    "lastUpdated": "2026/05/27 22:00",
    "lastAutomationSync": "2026/05/27 22:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.03%、S&P 500 +0.05%、費半 -0.45%。美股科技鏈中性，對 封測、其他、被動元件 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq +0.03%",
            "費半 -0.45%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +0.01%、東京威力科創 +2.10%、Advantest +4.05%。日股科技股續強，通常代表亞洲電子鏈對 封測、其他、被動元件 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +0.01%",
            "TEL +2.10%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +2.25%、Samsung +2.68%、SK Hynix +9.31%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +2.25%",
            "Samsung +2.68%",
            "Hynix +9.31%"
  ...
  "monteCarloScenarios": [
    {
      ...
      "name": "勤誠",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 623 - 1078",
      "stopLoss": "3% 停損命中率 90%",
      "takeProfit": "8% 停利命中率 59%",
      "drawdown": "模擬最大回撤中位數 29.5%",
    ...
    },
    {
      ...
      "name": "立隆",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 65 - 183",
      "stopLoss": "3% 停損命中率 91%",
      "takeProfit": "8% 停利命中率 75%",
      "drawdown": "模擬最大回撤中位數 48.0%",
