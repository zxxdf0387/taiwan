const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.21.0900",
    "lastUpdated": "2026/05/21 09:00",
    "lastAutomationSync": "2026/05/21 09:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +1.54%、S&P 500 +1.08%、費半 +4.74%。美股科技鏈偏多，對 被動元件、其他、封測 這組主軸有順風。",
          "signals": [
            "Nasdaq +1.54%",
            "費半 +4.74%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +1.72%、東京威力科創 +5.62%、Advantest +2.87%。日股科技股續強，通常代表亞洲電子鏈對 被動元件、其他、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +1.72%",
            "TEL +5.62%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +4.73%、Samsung +6.70%、SK Hynix +5.62%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +4.73%",
            "Samsung +6.70%",
            "Hynix +5.62%"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +1.54%、S&P 500 +1.08%、費半 +4.74%。美股科技鏈偏多，對 PCB、被動元件、封測 這組主軸有順風。",
          "signals": [
            "Nasdaq +1.54%",
            "費半 +4.74%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +1.72%、東京威力科創 +5.62%、Advantest +2.87%。日股科技股續強，通常代表亞洲電子鏈對 PCB、被動元件、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +1.72%",
            "TEL +5.62%",
            "日股偏多"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +1.54%、S&P 500 +1.08%、費半 +4.74%。美股科技鏈偏多，對 被動元件、封測、PCB 這組主軸有順風。",
          "signals": [
            "Nasdaq +1.54%",
            "費半 +4.74%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +1.72%、東京威力科創 +5.62%、Advantest +2.87%。日股科技股續強，通常代表亞洲電子鏈對 被動元件、封測、PCB 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +1.72%",
            "TEL +5.62%",
            "日股偏多"
  ...
  "stocks": [
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "超豐 在 2026/05/20、2026/05/19、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.859、40 日 %B 約 0.935；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "MOSFET",
      "note": "富鼎 在 2026/05/20、2026/05/19、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.581、40 日 %B 約 0.401；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
  ...
  "monteCarloScenarios": [
    ...
    },
    {
      ...
      "name": "健鼎",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 288 - 444",
      "stopLoss": "3% 停損命中率 83%",
      "takeProfit": "8% 停利命中率 53%",
      "drawdown": "模擬最大回撤中位數 22.5%",
    ...
    },
    {
      ...
      "name": "富鼎",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 71 - 115",
      "stopLoss": "3% 停損命中率 87%",
      "takeProfit": "8% 停利命中率 65%",
      "drawdown": "模擬最大回撤中位數 27.0%",
