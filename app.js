const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.01.0901",
    "lastUpdated": "2026/06/01 09:00",
    "lastAutomationSync": "2026/06/01 09:00",
    "videoBasis": "2026/05/29、2026/05/28、2026/05/27"
  },
  "marketMood": {
    "label": "主線延續偏多",
    "summary": "2026/05/29 到 2026/05/27 三支影片交叉後，佳必琪、良維、超豐、矽格、健鼎、奇鋐、貿聯、台燿、勤誠 是目前最穩的 3 日共通輪漲股；聯亞、聯鈞 則偏向高檔辨識。",
    "score": 82,
    "openingPlan": "先看 佳必琪、良維、超豐 是否續強"
  },
  "headlines": [
    {
      "tone": "positive",
      "title": "最新影片：2026/05/29",
      ...
      "analysis": "主軸偏向 其他、封測、線纜補漲。 和其他影片重複輪漲最多的是 佳必琪、良維、超豐、矽格、耿鼎。 高出辨識股集中在 聯亞、聯鈞。 當沖股則是 華邦、頎邦、台半、強茂，節奏偏快。",
      "tags": [
        "主軸 其他",
        "11 檔重複輪漲",
        "2 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.20%、S&P 500 +0.22%、費半 -0.07%。美股科技鏈中性，對 其他、封測、線纜補漲 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq +0.20%",
            "費半 -0.07%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +0.74%、東京威力科創 +3.36%、Advantest -1.80%。日股科技股續強，通常代表亞洲電子鏈對 其他、封測、線纜補漲 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +0.74%",
            "TEL +3.36%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +2.53%、Samsung +5.21%、SK Hynix -0.30%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +2.53%",
            "Samsung +5.21%",
            "Hynix -0.30%"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、封測、線纜補漲 輪動，蓋牌比較像 立隆、同欣電、安勤。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "立隆：曾在 2026/05/28 列輪漲 / 曾在 2026/05/27 列輪漲",
            "同欣電：曾在 2026/05/27 列輪漲 / 同屬 封測",
            "安勤：曾在 2026/05/28 列輪漲 / 曾在 2026/05/27 列輪漲"
          ]
        }
      }
    },
    {
      ...
      "analysis": "主軸偏向 其他、被動元件、封測。 和其他影片重複輪漲最多的是 立隆、超豐、佳必琪、矽格、良維。 高出辨識股集中在 聯亞、景碩、聯鈞。 當沖股則是 台半、強茂、聯電、頎邦，節奏偏快。",
      "tags": [
        "主軸 其他",
        "14 檔重複輪漲",
        "3 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.20%、S&P 500 +0.22%、費半 -0.07%。美股科技鏈中性，對 其他、被動元件、封測 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq +0.20%",
            "費半 -0.07%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +0.74%、東京威力科創 +3.36%、Advantest -1.80%。日股科技股續強，通常代表亞洲電子鏈對 其他、被動元件、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +0.74%",
            "TEL +3.36%",
            "日股偏多"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、被動元件、封測 輪動，蓋牌比較像 同欣電、力成、日電貿。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "同欣電：曾在 2026/05/27 列輪漲 / 同屬 封測",
            "力成：同屬 封測 / 同族群 封測",
            "日電貿：同屬 被動元件 / 同族群 被動元件"
          ]
        }
      }
    },
    {
      "tone": "neutral",
      "title": "再前一支影片：2026/05/27",
      "summary": "2026/05/27 這支影片把 立隆、超豐、同欣電、佳必琪、矽格、良維、安勤、健鼎、奇鋐、貿聯、台燿、勤誠、智邦列輪漲，盟立、直得續、尖點、聯亞、景碩、聯鈞列高出，台半、富鼎、強茂、聯電、華邦、頎邦列當沖。",
      "meta": "13 檔輪漲 ｜ 6 檔高出 ｜ 6 檔當沖",
      "analysis": "主軸偏向 封測、其他、被動元件。 和其他影片重複輪漲最多的是 立隆、超豐、佳必琪、矽格、良維。 高出辨識股集中在 聯亞、景碩、聯鈞。 當沖股則是 台半、強茂、聯電、華邦，節奏偏快。",
      "tags": [
        "主軸 封測",
        "12 檔重複輪漲",
        "3 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.20%、S&P 500 +0.22%、費半 -0.07%。美股科技鏈中性，對 封測、其他、被動元件 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq +0.20%",
            "費半 -0.07%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +0.74%、東京威力科創 +3.36%、Advantest -1.80%。日股科技股續強，通常代表亞洲電子鏈對 封測、其他、被動元件 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +0.74%",
            "TEL +3.36%",
            "日股偏多"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 封測、其他、被動元件 輪動，蓋牌比較像 尼克森、技嘉、耿鼎。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "尼克森：曾在 2026/05/28 列輪漲 / 同屬 被動元件",
            "技嘉：曾在 2026/05/29 列輪漲 / 曾在 2026/05/28 列輪漲",
  ...
  "stocks": [
    {
      ...
      "name": "佳必琪",
      "bias": "3日共通",
      "gap": "2026/05/29、2026/05/28、2026/05/27",
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "佳必琪 在 2026/05/29、2026/05/28、2026/05/27 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "線材 / AI 電源",
      "note": "良維 在 2026/05/29、2026/05/28、2026/05/27 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "超豐 在 2026/05/29、2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.286、40 日 %B 約 0.196；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/05/29、2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.993、40 日 %B 約 0.455；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "PCB",
      "note": "健鼎 在 2026/05/29、2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.010、40 日 %B 約 0.195；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 散熱 / 伺服器",
      "note": "奇鋐 在 2026/05/29、2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.590、40 日 %B 約 0.366；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/05/29、2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.560、40 日 %B 約 0.320；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "CCL / PCB",
      "note": "台燿 在 2026/05/29、2026/05/28、2026/05/27 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/05/29、2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.131、40 日 %B 約 0.280；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 伺服器 / 顯卡",
      "note": "技嘉 在 2026/05/29、2026/05/28 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.291、40 日 %B 約 0.217；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "立隆",
      "bias": "2日共通",
      "gap": "2026/05/28、2026/05/27",
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "立隆 在 2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.685、40 日 %B 約 0.364；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "安勤 在 2026/05/28、2026/05/27 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "網通 / 交換器",
      "note": "智邦 在 2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.486、40 日 %B 約 0.311；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
  ...
  "checklist": [
    "先看 2026/05/29 與前兩支影片的交叉輪漲股：佳必琪、良維、超豐、矽格、健鼎、奇鋐、貿聯、台燿、勤誠。",
    "高出股 聯亞、聯鈞 要和輪漲股分開，不要混成主攻名單。",
    "當沖股 華邦、頎邦、台半、強茂、聯電 屬快節奏，不適合直接列成首選。",
    "今天盤前先看 貿聯、奇鋐、超豐 是否續量。"
  ],
  "risks": [
    {
      "level": "high",
      "title": "影片基準已更新到 2026/05/29、2026/05/28、2026/05/27",
      "detail": "目前基準改用黃清照 YouTube 頻道 /videos 頁面排序，最新三支就是 2026/05/29、2026/05/28、2026/05/27。"
    },
    {
      "level": "medium",
      "title": "有出現三日共通輪漲股",
      "detail": "佳必琪、良維、超豐、矽格、健鼎、奇鋐、貿聯、台燿、勤誠 是目前最穩的 3 日共通輪漲股。"
    },
    {
      "level": "medium",
      "title": "高出股與當沖股要拆開處理",
      "detail": "聯亞、聯鈞 偏高檔辨識；華邦、頎邦、台半、強茂、聯電 偏快節奏，和輪漲股不是同一層級。"
    }
  ],
  "bollingerRankings": [
    {
  ...
  "markovModel": {
    "currentState": "主線延續偏多",
    "confidence": 82,
    "takeaway": "2026/05/29 到 2026/05/27 三支影片交叉後，佳必琪、良維、超豐、矽格、健鼎、奇鋐、貿聯、台燿、勤誠 是目前最穩的 3 日共通輪漲股；聯亞、聯鈞 則偏向高檔辨識。",
    "transitions": [
      {
        "label": "維持主線延續",
        "value": "82%"
    ...
    "drivers": [
      "2026/05/29 輪漲股是 萬泰科、佳必琪、良維、騰輝、超豐、神達、矽格、東洋",
      "2026/05/28 對照下，可直接交叉出 佳必琪、良維、超豐、矽格、耿鼎、健鼎、奇鋐、貿聯、台燿、勤誠、技嘉",
      "2026/05/27 對照下，可直接交叉出 佳必琪、良維、超豐、矽格、健鼎、奇鋐、貿聯、台燿、勤誠"
    ]
  },
  "monteCarloScenarios": [
    {
      ...
      "name": "貿聯",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 993 - 2048",
      "stopLoss": "3% 停損命中率 90%",
      "takeProfit": "8% 停利命中率 59%",
      "drawdown": "模擬最大回撤中位數 37.7%",
    ...
    },
    {
      ...
      "name": "奇鋐",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 1303 - 2369",
      "stopLoss": "3% 停損命中率 89%",
      "takeProfit": "8% 停利命中率 64%",
      "drawdown": "模擬最大回撤中位數 31.9%",
    ...
    },
    {
      ...
      "name": "超豐",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 61 - 113",
      "stopLoss": "3% 停損命中率 84%",
      "takeProfit": "8% 停利命中率 72%",
      "drawdown": "模擬最大回撤中位數 26.9%",
      "note": "超豐 屬於可以當第二層風險觀察的延續股。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
