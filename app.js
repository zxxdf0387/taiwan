const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.21.2201",
    "lastUpdated": "2026/05/21 22:00",
    "lastAutomationSync": "2026/05/21 22:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.35%、S&P 500 -0.23%、費半 +0.62%。美股科技鏈中性，對 被動元件、封測、感測 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq -0.35%",
            "費半 +0.62%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +3.14%、東京威力科創 +5.86%、Advantest +4.37%。日股科技股續強，通常代表亞洲電子鏈對 被動元件、封測、感測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +3.14%",
            "TEL +5.86%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +8.42%、Samsung +8.51%、SK Hynix +11.17%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +8.42%",
            "Samsung +8.51%",
            "Hynix +11.17%"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.35%、S&P 500 -0.23%、費半 +0.62%。美股科技鏈中性，對 被動元件、其他、封測 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq -0.35%",
            "費半 +0.62%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +3.14%、東京威力科創 +5.86%、Advantest +4.37%。日股科技股續強，通常代表亞洲電子鏈對 被動元件、其他、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +3.14%",
            "TEL +5.86%",
            "日股偏多"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.35%、S&P 500 -0.23%、費半 +0.62%。美股科技鏈中性，對 PCB、被動元件、封測 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq -0.35%",
            "費半 +0.62%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +3.14%、東京威力科創 +5.86%、Advantest +4.37%。日股科技股續強，通常代表亞洲電子鏈對 PCB、被動元件、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +3.14%",
            "TEL +5.86%",
            "日股偏多"
  ...
  "stocks": [
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "感測 / 封測",
      "note": "同欣電 在 2026/05/21、2026/05/20 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.006、40 日 %B 約 0.088；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/05/21、2026/05/20、2026/05/19 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.960、40 日 %B 約 0.722；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
  ...
  "monteCarloScenarios": [
    ...
    },
    {
      ...
      "name": "勤誠",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 599 - 1030",
      "stopLoss": "3% 停損命中率 88%",
      "takeProfit": "8% 停利命中率 53%",
      "drawdown": "模擬最大回撤中位數 31.0%",
