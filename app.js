const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.27.0901",
    "lastUpdated": "2026/05/27 09:00",
    "lastAutomationSync": "2026/05/27 09:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +1.19%、S&P 500 +0.61%、費半 +6.10%。美股科技鏈偏多，對 封測、其他、被動元件 這組主軸有順風。",
          "signals": [
            "Nasdaq +1.19%",
            "費半 +6.10%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +1.11%、東京威力科創 +4.57%、Advantest +4.72%。日股科技股續強，通常代表亞洲電子鏈對 封測、其他、被動元件 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +1.11%",
            "TEL +4.57%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +3.94%、Samsung +6.52%、SK Hynix +9.16%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +3.94%",
            "Samsung +6.52%",
            "Hynix +9.16%"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +1.19%、S&P 500 +0.61%、費半 +6.10%。美股科技鏈偏多，對 封測、其他、感測 這組主軸有順風。",
          "signals": [
            "Nasdaq +1.19%",
            "費半 +6.10%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +1.11%、東京威力科創 +4.57%、Advantest +4.72%。日股科技股續強，通常代表亞洲電子鏈對 封測、其他、感測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +1.11%",
            "TEL +4.57%",
            "日股偏多"
  ...
  "monteCarloScenarios": [
    {
      ...
      "name": "光寶",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 125 - 216",
      "stopLoss": "3% 停損命中率 83%",
      "takeProfit": "8% 停利命中率 68%",
      "drawdown": "模擬最大回撤中位數 28.4%",
    ...
    },
    {
      ...
      "name": "富鼎",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 62 - 125",
      "stopLoss": "3% 停損命中率 88%",
      "takeProfit": "8% 停利命中率 71%",
      "drawdown": "模擬最大回撤中位數 36.5%",
