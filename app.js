const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.11.2200",
    "lastUpdated": "2026/06/11 22:00",
    "lastAutomationSync": "2026/06/11 22:00",
    "videoBasis": "2026/06/11、2026/06/10、2026/06/09"
  },
  "marketMood": {
    "label": "主線延續偏多",
    "summary": "2026/06/11 到 2026/06/09 三支影片交叉後，東鹼、騰輝、佳必琪、良維、東陽、勤誠、健鼎、國巨、台燿 是目前最穩的 3 日共通輪漲股；高出股沒有連續重複 則偏向高檔辨識。",
    "score": 82,
    "openingPlan": "先看 東鹼、騰輝、佳必琪 是否續強"
  },
  "headlines": [
    {
      "tone": "positive",
      "title": "最新影片：2026/06/11",
      "summary": "2026/06/11 這支影片把 敬鵬、艾訊、東鹼、騰輝、佳必琪、安勤、良維、興勤、東陽、光寶、勤誠、健鼎、國巨、大立光、台燿、奇鋐、瑞昱、智邦列輪漲，華邦、聯電、日電貿、強茂、華通、南亞科、欣興列當沖。",
      "meta": "18 檔輪漲 ｜ 0 檔高出 ｜ 7 檔當沖",
      "analysis": "主軸偏向 其他、PCB、工業電腦。 和其他影片重複輪漲最多的是 東鹼、騰輝、佳必琪、安勤、良維。 當沖股則是 華邦、聯電、華通，節奏偏快。",
      "tags": [
        "主軸 其他",
        "12 檔重複輪漲",
        "3 檔重複當沖"
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.77%、S&P 500 +0.56%、費半 +4.45%。美股科技鏈偏多，對 其他、PCB、工業電腦 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.77%",
            "費半 +4.45%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +0.06%、東京威力科創 +2.54%、Advantest -0.24%。日股科技股續強，通常代表亞洲電子鏈對 其他、PCB、工業電腦 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +0.06%",
            "TEL +2.54%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +0.43%、Samsung -1.16%、SK Hynix +2.59%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +0.43%",
            "Samsung -1.16%",
            "Hynix +2.59%"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、PCB、工業電腦 輪動，蓋牌比較像 金像電、矽格、胡連。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "金像電：曾在 2026/06/10 列輪漲 / 曾在 2026/06/09 列輪漲",
            "矽格：曾在 2026/06/10 列輪漲 / 曾在 2026/06/09 列輪漲",
            "胡連：曾在 2026/06/10 列輪漲 / 曾在 2026/06/09 列輪漲"
          ]
        }
      }
    },
    {
      "tone": "neutral",
      "title": "前一支影片：2026/06/10",
      "summary": "2026/06/10 這支影片把 東陽、康普、佳必琪、騰輝、安勤、胡連、矽格、東鹼、良維、尼克森、大立光、金像電、勤誠、雙鴻、國巨、台燿、健鼎列輪漲，盟立、南電、聯亞、聯鈞列高出。",
      "meta": "17 檔輪漲 ｜ 4 檔高出 ｜ 0 檔當沖",
      "analysis": "主軸偏向 其他、被動元件、PCB。 和其他影片重複輪漲最多的是 東陽、康普、佳必琪、騰輝、安勤。 高出辨識股集中在 盟立、南電、聯亞、聯鈞。",
      "tags": [
        "主軸 其他",
        "16 檔重複輪漲",
        "4 檔重複高出"
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.77%、S&P 500 +0.56%、費半 +4.45%。美股科技鏈偏多，對 其他、被動元件、PCB 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.77%",
            "費半 +4.45%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +0.06%、東京威力科創 +2.54%、Advantest -0.24%。日股科技股續強，通常代表亞洲電子鏈對 其他、被動元件、PCB 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +0.06%",
            "TEL +2.54%",
            "日股偏多"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、被動元件、PCB 輪動，蓋牌比較像 光寶、敬鵬、華通。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "光寶：曾在 2026/06/11 列輪漲 / 曾在 2026/06/09 列輪漲",
            "敬鵬：曾在 2026/06/11 列輪漲 / 同屬 PCB",
            "華通：曾在 2026/06/11 列當沖 / 曾在 2026/06/09 列當沖"
          ]
        }
      }
    },
    {
      "tone": "neutral",
      "title": "再前一支影片：2026/06/09",
      "summary": "2026/06/09 這支影片把 東陽、康普、佳必琪、騰輝、神達、胡連、光寶、矽格、東鹼、川湖、金像電、勤誠、雙鴻、國巨、台燿、健鼎、良維列輪漲，盟立、南電、聯亞、聯鈞列高出，華通、華邦、聯電列當沖。",
      "meta": "17 檔輪漲 ｜ 4 檔高出 ｜ 3 檔當沖",
      "analysis": "主軸偏向 其他、PCB、電池材料。 和其他影片重複輪漲最多的是 東陽、康普、佳必琪、騰輝、胡連。 高出辨識股集中在 盟立、南電、聯亞、聯鈞。 當沖股則是 華通、華邦、聯電，節奏偏快。",
      "tags": [
        "主軸 其他",
        "15 檔重複輪漲",
        "4 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.77%、S&P 500 +0.56%、費半 +4.45%。美股科技鏈偏多，對 其他、PCB、電池材料 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.77%",
            "費半 +4.45%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +0.06%、東京威力科創 +2.54%、Advantest -0.24%。日股科技股續強，通常代表亞洲電子鏈對 其他、PCB、電池材料 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +0.06%",
            "TEL +2.54%",
            "日股偏多"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、PCB、電池材料 輪動，蓋牌比較像 大立光、安勤、敬鵬。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "大立光：曾在 2026/06/11 列輪漲 / 曾在 2026/06/10 列輪漲",
            "安勤：曾在 2026/06/11 列輪漲 / 曾在 2026/06/10 列輪漲",
            "敬鵬：曾在 2026/06/11 列輪漲 / 同屬 PCB"
          ]
        }
      }
  ...
  "stocks": [
    {
      ...
      "name": "東鹼",
      "bias": "3日共通",
      "gap": "2026/06/11、2026/06/10、2026/06/09",
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "東鹼 在 2026/06/11、2026/06/10、2026/06/09 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "騰輝 在 2026/06/11、2026/06/10、2026/06/09 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "佳必琪 在 2026/06/11、2026/06/10、2026/06/09 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "安勤",
      "bias": "2日共通",
      "gap": "2026/06/11、2026/06/10",
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "安勤 在 2026/06/11、2026/06/10 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "線材 / AI 電源",
      "note": "良維 在 2026/06/11、2026/06/10、2026/06/09 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "東陽 在 2026/06/11、2026/06/10、2026/06/09 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "光寶",
      "bias": "2日共通",
      "gap": "2026/06/11、2026/06/09",
      "foreign": "交叉輪漲",
      "volume": "電源 / 電子權值",
      "note": "光寶 在 2026/06/11、2026/06/09 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.112、40 日 %B 約 -0.122；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/06/11、2026/06/10、2026/06/09 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.131、40 日 %B 約 0.280；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "PCB",
      "note": "健鼎 在 2026/06/11、2026/06/10、2026/06/09 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.010、40 日 %B 約 0.195；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "國巨 在 2026/06/11、2026/06/10、2026/06/09 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.061、40 日 %B 約 0.127；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "光學權值",
      "note": "大立光 在 2026/06/11、2026/06/10 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.033、40 日 %B 約 0.130；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "CCL / PCB",
      "note": "台燿 在 2026/06/11、2026/06/10、2026/06/09 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "康普",
      "bias": "2日共通",
      "gap": "2026/06/10、2026/06/09",
      "foreign": "交叉輪漲",
      "volume": "電池材料",
      "note": "康普 在 2026/06/10、2026/06/09 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "胡連 在 2026/06/10、2026/06/09 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
  ...
  "checklist": [
    "先看 2026/06/11 與前兩支影片的交叉輪漲股：東鹼、騰輝、佳必琪、良維、東陽、勤誠、健鼎、國巨、台燿。",
    "若高出股沒有重複，就優先看輪漲股延續。",
    "當沖股 華邦、聯電、華通 屬快節奏，不適合直接列成首選。",
    "今天盤前先看 勤誠、國巨、金像電 是否續量。"
  ],
  "risks": [
    {
      "level": "high",
      "title": "影片基準已更新到 2026/06/11、2026/06/10、2026/06/09",
      "detail": "目前基準改用黃清照 YouTube 頻道 /videos 頁面排序，最新三支就是 2026/06/11、2026/06/10、2026/06/09。"
    },
    {
      "level": "medium",
      "title": "有出現三日共通輪漲股",
      "detail": "東鹼、騰輝、佳必琪、良維、東陽、勤誠、健鼎、國巨、台燿 是目前最穩的 3 日共通輪漲股。"
    },
    {
      "level": "medium",
      "title": "高出股與當沖股要拆開處理",
      "detail": "高出股暫無重複 偏高檔辨識；華邦、聯電、華通 偏快節奏，和輪漲股不是同一層級。"
    }
  ],
  "bollingerRankings": [
    {
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/06/11 收盤",
      "summary": "國巨 用 TWSE 官方日資料重算後，20 日 %B 約 0.061、40 日 %B 約 0.127；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.061",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/06/11 收盤",
      "summary": "金像電 用 TWSE 官方日資料重算後，20 日 %B 約 0.426、40 日 %B 約 0.295；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "2日共通",
        "20日 %B 0.426",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/06/11 收盤",
      "summary": "健鼎 用 TWSE 官方日資料重算後，20 日 %B 約 -0.010、40 日 %B 約 0.195；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B -0.010",
        "40日不過熱"
  ...
  "markovModel": {
    "currentState": "主線延續偏多",
    "confidence": 82,
    "takeaway": "2026/06/11 到 2026/06/09 三支影片交叉後，東鹼、騰輝、佳必琪、良維、東陽、勤誠、健鼎、國巨、台燿 是目前最穩的 3 日共通輪漲股；高出股沒有連續重複 則偏向高檔辨識。",
    "transitions": [
      {
        "label": "維持主線延續",
        "value": "82%"
    ...
    "drivers": [
      "2026/06/11 輪漲股是 敬鵬、艾訊、東鹼、騰輝、佳必琪、安勤、良維、興勤",
      "2026/06/10 對照下，可直接交叉出 東鹼、騰輝、佳必琪、安勤、良維、東陽、勤誠、健鼎、國巨、大立光、台燿",
      "2026/06/09 對照下，可直接交叉出 東鹼、騰輝、佳必琪、良維、東陽、光寶、勤誠、健鼎、國巨、台燿"
    ]
  },
  "monteCarloScenarios": [
    {
    ...
    },
    {
      ...
      "name": "國巨",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 132 - 400",
      "stopLoss": "3% 停損命中率 88%",
      "takeProfit": "8% 停利命中率 77%",
      "drawdown": "模擬最大回撤中位數 45.9%",
      "note": "國巨 屬於可以當第二層風險觀察的延續股。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "金像電",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 507 - 1017",
      "stopLoss": "3% 停損命中率 91%",
      "takeProfit": "8% 停利命中率 65%",
      "drawdown": "模擬最大回撤中位數 36.1%",
      "note": "金像電 屬於可以當第二層風險觀察的延續股。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
