const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.09.2200",
    "lastUpdated": "2026/06/09 22:00",
    "lastAutomationSync": "2026/06/09 22:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.76%、S&P 500 +0.68%、費半 +1.90%。美股科技鏈偏多，對 其他、PCB、電池材料 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.76%",
            "費半 +1.90%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.17%、東京威力科創 +8.91%、Advantest +4.34%。日股科技股續強，通常代表亞洲電子鏈對 其他、PCB、電池材料 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.17%",
            "TEL +8.91%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +8.18%、Samsung +8.97%、SK Hynix +15.91%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +8.18%",
            "Samsung +8.97%",
            "Hynix +15.91%"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.76%、S&P 500 +0.68%、費半 +1.90%。美股科技鏈偏多，對 其他、PCB、AI 機殼 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.76%",
            "費半 +1.90%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.17%、東京威力科創 +8.91%、Advantest +4.34%。日股科技股續強，通常代表亞洲電子鏈對 其他、PCB、AI 機殼 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.17%",
            "TEL +8.91%",
            "日股偏多"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.76%、S&P 500 +0.68%、費半 +1.90%。美股科技鏈偏多，對 其他、電源、封測 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.76%",
            "費半 +1.90%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.17%、東京威力科創 +8.91%、Advantest +4.34%。日股科技股續強，通常代表亞洲電子鏈對 其他、電源、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.17%",
            "TEL +8.91%",
            "日股偏多"
  ...
  "stocks": [
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/06/09、2026/06/08、2026/06/05 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.131、40 日 %B 約 0.251；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
  ...
  "bollingerRankings": [
    {
      ...
      "summary": "勤誠 用 TWSE 官方日資料重算後，20 日 %B 約 0.131、40 日 %B 約 0.251；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.131",
        "40日不過熱"
  ...
  "monteCarloScenarios": [
    {
      ...
      "name": "勤誠",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 528 - 969",
      "stopLoss": "3% 停損命中率 91%",
      "takeProfit": "8% 停利命中率 57%",
      "drawdown": "模擬最大回撤中位數 33.3%",
    ...
    },
    {
      ...
      "name": "金像電",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 508 - 1062",
      "stopLoss": "3% 停損命中率 87%",
      "takeProfit": "8% 停利命中率 66%",
      "drawdown": "模擬最大回撤中位數 38.6%",
