const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.25.2200",
    "lastUpdated": "2026/05/25 22:00",
    "lastAutomationSync": "2026/05/25 22:00",
    "videoBasis": "2026/05/25、2026/05/22、2026/05/21"
  },
  "marketMood": {
    "label": "主線延續偏多",
    "summary": "2026/05/25 到 2026/05/21 三支影片交叉後，超豐、同欣電、光寶、矽格、良維、安勤、國巨、奇鋐、貿聯、勤誠 是目前最穩的 3 日共通輪漲股；盟立、尖點、聯亞、景碩、穩懋 則偏向高檔辨識。",
    "score": 82,
    "openingPlan": "先看 富鼎、超豐、同欣電 是否續強"
  },
  "headlines": [
    {
      "tone": "positive",
      "title": "最新影片：2026/05/25",
      "summary": "2026/05/25 這支影片把 富鼎、超豐、同欣電、光寶、佳必琪、矽格、良維、緯創、安勤、國巨、立隆、力成、奇鋐、貿聯、台燿、勤誠列輪漲，盟立、所羅門續、尖點、聯亞、景碩、穩懋列高出，聯電、群創、頎邦列當沖。",
      "meta": "16 檔輪漲 ｜ 6 檔高出 ｜ 3 檔當沖",
      "analysis": "主軸偏向 封測、其他、被動元件。 和其他影片重複輪漲最多的是 富鼎、超豐、同欣電、光寶、佳必琪。 高出辨識股集中在 盟立、尖點、聯亞、景碩。 當沖股則是 聯電、群創、頎邦，節奏偏快。",
      "tags": [
        "主軸 封測",
        "15 檔重複輪漲",
        "5 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.19%、S&P 500 +0.37%、費半 +2.41%。美股科技鏈偏多，對 封測、其他、被動元件 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.19%",
            "費半 +2.41%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.87%、東京威力科創 +4.72%、Advantest +3.39%。日股科技股續強，通常代表亞洲電子鏈對 封測、其他、被動元件 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.87%",
            "TEL +4.72%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +0.41%、Samsung -2.34%、SK Hynix +0.05%。韓股電子權值轉弱，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +0.41%",
            "Samsung -2.34%",
            "Hynix +0.05%"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 封測、其他、被動元件 輪動，蓋牌比較像 日電貿、尼克森、健鼎。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "日電貿：曾在 2026/05/21 列輪漲 / 同屬 被動元件",
            "尼克森：曾在 2026/05/21 列輪漲 / 同屬 被動元件",
            "健鼎：曾在 2026/05/22 列輪漲 / 曾在 2026/05/21 列輪漲"
          ]
        }
      }
    },
    {
      "tone": "neutral",
      "title": "前一支影片：2026/05/22",
      "summary": "2026/05/22 這支影片把 同欣電、超豐、安勤、佳必琪、富鼎、矽格、良維、光寶、緯創、國巨、力成、奇鋐、貿聯、健鼎、勤誠列輪漲，盟立、所羅門、尖點、聯亞、景碩、聯鈞、穩懋列高出，聯電、群創、頎邦列當沖。",
      "meta": "15 檔輪漲 ｜ 7 檔高出 ｜ 3 檔當沖",
      "analysis": "主軸偏向 封測、其他、感測。 和其他影片重複輪漲最多的是 同欣電、超豐、安勤、佳必琪、富鼎。 高出辨識股集中在 盟立、所羅門、尖點、聯亞。 當沖股則是 聯電、群創、頎邦，節奏偏快。",
      "tags": [
        "主軸 封測",
        "15 檔重複輪漲",
        "6 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.19%、S&P 500 +0.37%、費半 +2.41%。美股科技鏈偏多，對 封測、其他、感測 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.19%",
            "費半 +2.41%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.87%、東京威力科創 +4.72%、Advantest +3.39%。日股科技股續強，通常代表亞洲電子鏈對 封測、其他、感測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.87%",
            "TEL +4.72%",
            "日股偏多"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 封測、其他、感測 輪動，蓋牌比較像 立隆、日電貿、台燿。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "立隆：曾在 2026/05/25 列輪漲 / 曾在 2026/05/21 列輪漲",
            "日電貿：曾在 2026/05/21 列輪漲",
            "台燿：曾在 2026/05/25 列輪漲"
          ]
        }
      }
    },
    {
      "tone": "neutral",
      "title": "再前一支影片：2026/05/21",
      "summary": "2026/05/21 這支影片把 同欣電、日電貿、立隆、尼克森、超豐、矽格、良維、安勤、光寶、國巨、智邦、勤誠、奇鋐、健鼎、貿聯列輪漲，盟立、所羅門、尖點、聯亞、景碩、穩懋列高出，聯電、群創、頎邦、富鼎列當沖。",
      "meta": "15 檔輪漲 ｜ 6 檔高出 ｜ 4 檔當沖",
      "analysis": "主軸偏向 被動元件、封測、感測。 和其他影片重複輪漲最多的是 同欣電、立隆、超豐、矽格、良維。 高出辨識股集中在 盟立、所羅門、尖點、聯亞。 當沖股則是 聯電、群創、頎邦，節奏偏快。",
      "tags": [
        "主軸 被動元件",
        "12 檔重複輪漲",
        "6 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.19%、S&P 500 +0.37%、費半 +2.41%。美股科技鏈偏多，對 被動元件、封測、感測 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.19%",
            "費半 +2.41%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.87%、東京威力科創 +4.72%、Advantest +3.39%。日股科技股續強，通常代表亞洲電子鏈對 被動元件、封測、感測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.87%",
            "TEL +4.72%",
            "日股偏多"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 被動元件、封測、感測 輪動，蓋牌比較像 力成、佳必琪、緯創。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "力成：曾在 2026/05/25 列輪漲 / 曾在 2026/05/22 列輪漲",
            "佳必琪：曾在 2026/05/25 列輪漲 / 曾在 2026/05/22 列輪漲",
            "緯創：曾在 2026/05/25 列輪漲 / 曾在 2026/05/22 列輪漲"
          ]
        }
      }
    }
  ...
  "stocks": [
    {
      ...
      "name": "富鼎",
      "bias": "2日共通",
      "gap": "2026/05/25、2026/05/22、2026/05/21",
      "foreign": "交叉輪漲",
      "volume": "MOSFET",
      "note": "富鼎 在 2026/05/25、2026/05/22 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.581、40 日 %B 約 0.401；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "超豐 在 2026/05/25、2026/05/22、2026/05/21 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.859、40 日 %B 約 0.935；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "感測 / 封測",
      "note": "同欣電 在 2026/05/25、2026/05/22、2026/05/21 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.680、40 日 %B 約 0.534；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "電源 / 電子權值",
      "note": "光寶 在 2026/05/25、2026/05/22、2026/05/21 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.616、40 日 %B 約 0.678；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "佳必琪",
      "bias": "2日共通",
      "gap": "2026/05/25、2026/05/22",
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "佳必琪 在 2026/05/25、2026/05/22 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/05/25、2026/05/22、2026/05/21 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.960、40 日 %B 約 0.648；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "線材 / AI 電源",
      "note": "良維 在 2026/05/25、2026/05/22、2026/05/21 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI PC / 伺服器",
      "note": "緯創 在 2026/05/25、2026/05/22 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 1.011、40 日 %B 約 0.734；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "安勤 在 2026/05/25、2026/05/22、2026/05/21 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "國巨 在 2026/05/25、2026/05/22、2026/05/21 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.994、40 日 %B 約 0.791；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "立隆",
      "bias": "2日共通",
      "gap": "2026/05/25、2026/05/21",
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "立隆 在 2026/05/25、2026/05/21 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.736、40 日 %B 約 0.523；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "力成 在 2026/05/25、2026/05/22 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.784、40 日 %B 約 0.925；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 散熱 / 伺服器",
      "note": "奇鋐 在 2026/05/25、2026/05/22、2026/05/21 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.462、40 日 %B 約 0.378；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/05/25、2026/05/22、2026/05/21 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.385、40 日 %B 約 0.314；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
  ...
  "checklist": [
    "先看 2026/05/25 與前兩支影片的交叉輪漲股：超豐、同欣電、光寶、矽格、良維、安勤、國巨、奇鋐、貿聯、勤誠。",
    "高出股 盟立、尖點、聯亞、景碩、穩懋 要和輪漲股分開，不要混成主攻名單。",
    "當沖股 聯電、群創、頎邦 屬快節奏，不適合直接列成首選。",
    "今天盤前先看 光寶、同欣電、勤誠 是否續量。"
  ],
  "risks": [
    {
      "level": "high",
      "title": "影片基準已更新到 2026/05/25、2026/05/22、2026/05/21",
      "detail": "目前基準改用黃清照 YouTube 頻道 /videos 頁面排序，最新三支就是 2026/05/25、2026/05/22、2026/05/21。"
    },
    {
      "level": "medium",
      "title": "有出現三日共通輪漲股",
      "detail": "超豐、同欣電、光寶、矽格、良維、安勤、國巨、奇鋐、貿聯、勤誠 是目前最穩的 3 日共通輪漲股。"
    },
    {
      "level": "medium",
      "title": "高出股與當沖股要拆開處理",
      "detail": "盟立、尖點、聯亞、景碩、穩懋 偏高檔辨識；聯電、群創、頎邦 偏快節奏，和輪漲股不是同一層級。"
    }
  ],
  "bollingerRankings": [
    {
      ...
      "name": "光寶",
      "verdict": "今日首選",
      "asOf": "截至 2026/05/25 收盤",
      "summary": "光寶 用 TWSE 官方日資料重算後，20 日 %B 約 0.616、40 日 %B 約 0.678；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.616",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/05/25 收盤",
      "summary": "同欣電 用 TWSE 官方日資料重算後，20 日 %B 約 0.680、40 日 %B 約 0.534；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.680",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/05/25 收盤",
      "summary": "奇鋐 用 TWSE 官方日資料重算後，20 日 %B 約 0.462、40 日 %B 約 0.378；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.462",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/05/25 收盤",
      "summary": "貿聯 用 TWSE 官方日資料重算後，20 日 %B 約 0.385、40 日 %B 約 0.314；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.385",
        "40日不過熱"
  ...
  "markovModel": {
    "currentState": "主線延續偏多",
    "confidence": 82,
    "takeaway": "2026/05/25 到 2026/05/21 三支影片交叉後，超豐、同欣電、光寶、矽格、良維、安勤、國巨、奇鋐、貿聯、勤誠 是目前最穩的 3 日共通輪漲股；盟立、尖點、聯亞、景碩、穩懋 則偏向高檔辨識。",
    "transitions": [
      {
        "label": "維持主線延續",
        "value": "82%"
    ...
    "drivers": [
      "2026/05/25 輪漲股是 富鼎、超豐、同欣電、光寶、佳必琪、矽格、良維、緯創",
      "2026/05/22 對照下，可直接交叉出 富鼎、超豐、同欣電、光寶、佳必琪、矽格、良維、緯創、安勤、國巨、力成、奇鋐、貿聯、勤誠",
      "2026/05/21 對照下，可直接交叉出 超豐、同欣電、光寶、矽格、良維、安勤、國巨、立隆、奇鋐、貿聯、勤誠"
    ]
  },
  "monteCarloScenarios": [
    {
      ...
      "name": "光寶",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 125 - 213",
      "stopLoss": "3% 停損命中率 85%",
      "takeProfit": "8% 停利命中率 64%",
      "drawdown": "模擬最大回撤中位數 26.2%",
    ...
    },
    {
      ...
      "name": "同欣電",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 131 - 254",
      "stopLoss": "3% 停損命中率 79%",
      "takeProfit": "8% 停利命中率 78%",
      "drawdown": "模擬最大回撤中位數 29.1%",
      "note": "同欣電 屬於可以當第二層風險觀察的延續股。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "勤誠",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 607 - 1093",
      "stopLoss": "3% 停損命中率 88%",
      "takeProfit": "8% 停利命中率 59%",
      "drawdown": "模擬最大回撤中位數 31.4%",
