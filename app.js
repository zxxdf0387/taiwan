const appState = {
  ...
  "updateMeta": {
    ...
    "lastUpdated": "2026/05/22 09:00",
    "lastAutomationSync": "2026/05/22 09:00",
    "videoBasis": "2026/05/21、2026/05/20、2026/05/19"
  },
  "marketMood": {
    "label": "主線延續偏多",
    "summary": "2026/05/21 到 2026/05/19 三支影片交叉後，日電貿、立隆、超豐、矽格、良維、光寶、國巨、勤誠、奇鋐、健鼎、貿聯 是目前最穩的 3 日共通輪漲股；盟立、所羅門、尖點、聯亞、穩懋 則偏向高檔辨識。",
    "score": 82,
    "openingPlan": "先看 同欣電、日電貿、立隆 是否續強"
  },
  "headlines": [
    {
      "tone": "positive",
      "title": "最新影片：2026/05/21",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.09%、S&P 500 +0.17%、費半 +0.85%。美股科技鏈中性，對 被動元件、封測、感測 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq +0.09%",
            "費半 +0.85%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +4.96%、東京威力科創 -0.08%、Advantest +0.02%。日股科技股續強，通常代表亞洲電子鏈對 被動元件、封測、感測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +4.96%",
            "TEL -0.08%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +9.16%、Samsung -1.17%、SK Hynix +0.10%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +9.16%",
            "Samsung -1.17%",
            "Hynix +0.10%"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.09%、S&P 500 +0.17%、費半 +0.85%。美股科技鏈中性，對 被動元件、其他、封測 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq +0.09%",
            "費半 +0.85%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +4.96%、東京威力科創 -0.08%、Advantest +0.02%。日股科技股續強，通常代表亞洲電子鏈對 被動元件、其他、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +4.96%",
            "TEL -0.08%",
            "日股偏多"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 被動元件、其他、封測 輪動，蓋牌比較像 尼克森、力成、京元電。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
    ...
    },
    {
      ...
      "analysis": "主軸偏向 PCB、被動元件、封測。 和其他影片重複輪漲最多的是 國巨、勤誠、奇鋐、健鼎、貿聯。 高出辨識股集中在 尖點、聯亞、穩懋、盟立。 當沖股則是 聯電、群創、頎邦，節奏偏快。",
      "tags": [
        "主軸 PCB",
        "12 檔重複輪漲",
        "5 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.09%、S&P 500 +0.17%、費半 +0.85%。美股科技鏈中性，對 PCB、被動元件、封測 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq +0.09%",
            "費半 +0.85%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +4.96%、東京威力科創 -0.08%、Advantest +0.02%。日股科技股續強，通常代表亞洲電子鏈對 PCB、被動元件、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +4.96%",
            "TEL -0.08%",
            "日股偏多"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 PCB、被動元件、封測 輪動，蓋牌比較像 同欣電、尼克森、安勤。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "同欣電：曾在 2026/05/21 列輪漲 / 曾在 2026/05/20 列輪漲",
            "尼克森：曾在 2026/05/21 列輪漲 / 同屬 被動元件",
            "安勤：曾在 2026/05/21 列輪漲 / 曾在 2026/05/20 列輪漲"
          ]
        }
      }
    }
  ...
  "stocks": [
    {
      ...
      "name": "富鼎",
      "bias": "2日共通",
      "gap": "2026/05/21、2026/05/20、2026/05/19",
      "foreign": "交叉輪漲",
      "volume": "MOSFET",
      "note": "富鼎 在 2026/05/20、2026/05/19 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.581、40 日 %B 約 0.401；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "感測 / 封測",
      "note": "同欣電 在 2026/05/21、2026/05/20 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.952、40 日 %B 約 0.890；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "被動元件通路",
      "note": "日電貿 在 2026/05/21、2026/05/20、2026/05/19 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.894、40 日 %B 約 0.859；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "立隆 在 2026/05/21、2026/05/20、2026/05/19 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.736、40 日 %B 約 0.523；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "超豐 在 2026/05/21、2026/05/20、2026/05/19 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.859、40 日 %B 約 0.935；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/05/21、2026/05/20、2026/05/19 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.960、40 日 %B 約 0.648；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "線材 / AI 電源",
      "note": "良維 在 2026/05/21、2026/05/20、2026/05/19 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "安勤 在 2026/05/21、2026/05/20 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "電源 / 電子權值",
      "note": "光寶 在 2026/05/21、2026/05/20、2026/05/19 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.616、40 日 %B 約 0.678；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "國巨 在 2026/05/21、2026/05/20、2026/05/19 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.994、40 日 %B 約 0.791；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "網通 / 交換器",
      "note": "智邦 在 2026/05/21、2026/05/20 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.466、40 日 %B 約 0.378；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/05/21、2026/05/20、2026/05/19 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.459、40 日 %B 約 0.415；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 散熱 / 伺服器",
      "note": "奇鋐 在 2026/05/21、2026/05/20、2026/05/19 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.462、40 日 %B 約 0.378；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "PCB",
      "note": "健鼎 在 2026/05/21、2026/05/20、2026/05/19 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.658、40 日 %B 約 0.523；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
  ...
  "checklist": [
    "先看 2026/05/21 與前兩支影片的交叉輪漲股：日電貿、立隆、超豐、矽格、良維、光寶、國巨、勤誠、奇鋐、健鼎、貿聯。",
  ...
  "risks": [
    {
      "level": "high",
      "title": "影片基準已更新到 2026/05/21、2026/05/20、2026/05/19",
      "detail": "目前基準改用黃清照 YouTube 頻道 /videos 頁面排序，最新三支就是 2026/05/21、2026/05/20、2026/05/19。"
    },
    {
      "level": "medium",
      "title": "有出現三日共通輪漲股",
      "detail": "日電貿、立隆、超豐、矽格、良維、光寶、國巨、勤誠、奇鋐、健鼎、貿聯 是目前最穩的 3 日共通輪漲股。"
    },
    {
      "level": "medium",
      "title": "高出股與當沖股要拆開處理",
  ...
  "markovModel": {
    "currentState": "主線延續偏多",
    "confidence": 82,
    "takeaway": "2026/05/21 到 2026/05/19 三支影片交叉後，日電貿、立隆、超豐、矽格、良維、光寶、國巨、勤誠、奇鋐、健鼎、貿聯 是目前最穩的 3 日共通輪漲股；盟立、所羅門、尖點、聯亞、穩懋 則偏向高檔辨識。",
    "transitions": [
      {
        "label": "維持主線延續",
        "value": "82%"
    ...
    "drivers": [
      "2026/05/21 輪漲股是 同欣電、日電貿、立隆、尼克森、超豐、矽格、良維、安勤",
      "2026/05/20 對照下，可直接交叉出 同欣電、日電貿、立隆、超豐、矽格、良維、安勤、光寶、國巨、智邦、勤誠、奇鋐、健鼎、貿聯",
      "2026/05/19 對照下，可直接交叉出 日電貿、立隆、超豐、矽格、良維、光寶、國巨、勤誠、奇鋐、健鼎、貿聯"
    ]
  },
  "monteCarloScenarios": [
    {
