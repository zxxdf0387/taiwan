const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.26.0900",
    "lastUpdated": "2026/05/26 09:00",
    "lastAutomationSync": "2026/05/26 09:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.46%、東京威力科創 -2.74%、Advantest -5.73%。日股科技股轉弱，通常代表亞洲電子鏈對 封測、其他、被動元件 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.46%",
            "TEL -2.74%",
            "日股轉弱"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +3.54%、Samsung +2.91%、SK Hynix +7.14%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +3.54%",
            "Samsung +2.91%",
            "Hynix +7.14%"
    ...
    },
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.46%、東京威力科創 -2.74%、Advantest -5.73%。日股科技股轉弱，通常代表亞洲電子鏈對 封測、其他、感測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.46%",
            "TEL -2.74%",
            "日股轉弱"
    ...
    },
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.46%、東京威力科創 -2.74%、Advantest -5.73%。日股科技股轉弱，通常代表亞洲電子鏈對 被動元件、封測、感測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.46%",
            "TEL -2.74%",
            "日股轉弱"
  ...
  "stocks": [
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "感測 / 封測",
      "note": "同欣電 在 2026/05/25、2026/05/22、2026/05/21 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.952、40 日 %B 約 0.890；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
  ...
  "bollingerRankings": [
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/05/25 收盤",
      "summary": "矽格 用 TWSE 官方日資料重算後，20 日 %B 約 0.960、40 日 %B 約 0.648；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.960",
        "40日不過熱"
  ...
  "monteCarloScenarios": [
    {
      ...
      "name": "光寶",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 126 - 224",
      "stopLoss": "3% 停損命中率 85%",
      "takeProfit": "8% 停利命中率 65%",
      "drawdown": "模擬最大回撤中位數 26.4%",
    ...
    },
    {
      ...
      "name": "勤誠",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 613 - 1058",
      "stopLoss": "3% 停損命中率 88%",
      "takeProfit": "8% 停利命中率 66%",
      "drawdown": "模擬最大回撤中位數 30.1%",
    ...
    },
    {
      ...
      "name": "奇鋐",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 1142 - 2279",
      "stopLoss": "3% 停損命中率 84%",
      "takeProfit": "8% 停利命中率 67%",
      "drawdown": "模擬最大回撤中位數 32.3%",
