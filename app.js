const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.09.0900",
    "lastUpdated": "2026/06/09 09:00",
    "lastAutomationSync": "2026/06/09 09:00",
    "videoBasis": "2026/06/08、2026/06/05、2026/06/04"
  },
  "marketMood": {
    "label": "主線延續偏多",
    "summary": "2026/06/08 到 2026/06/04 三支影片交叉後，勤誠、雙鴻、智邦、健鼎、良維 是目前最穩的 3 日共通輪漲股；盟立、英業達、聯亞、聯鈞 則偏向高檔辨識。",
    "score": 82,
    "openingPlan": "先看 勤誠、雙鴻、智邦 是否續量"
  },
  "headlines": [
    {
      "tone": "positive",
      "title": "最新影片：2026/06/08",
      "summary": "2026/06/08 這支影片把 力旺、金像電、勤誠、雙鴻、智邦、健鼎、良維列輪漲，盟立、英業達、聯亞、聯鈞列高出，緯創、華邦、聯電列當沖。",
      "meta": "7 檔輪漲 ｜ 4 檔高出 ｜ 3 檔當沖",
      "analysis": "主軸偏向 其他、PCB、AI 機殼。 和其他影片重複輪漲最多的是 勤誠、雙鴻、智邦、健鼎、良維。 高出辨識股集中在 盟立、英業達、聯亞、聯鈞。 當沖股則是 緯創、華邦、聯電，節奏偏快。",
      "tags": [
        "主軸 其他",
        "5 檔重複輪漲",
        "4 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.86%、S&P 500 +0.30%、費半 +5.87%。美股科技鏈偏多，對 其他、PCB、AI 機殼 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.86%",
            "費半 +5.87%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -3.57%、東京威力科創 +5.34%、Advantest +1.74%。日股科技股續強，通常代表亞洲電子鏈對 其他、PCB、AI 機殼 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -3.57%",
            "TEL +5.34%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI -5.33%、Samsung +3.55%、SK Hynix +6.33%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI -5.33%",
            "Samsung +3.55%",
            "Hynix +6.33%"
        ...
        "hidden": {
          ...
          "signals": [
            "台燿：曾在 2026/06/05 列輪漲 / 曾在 2026/06/04 列輪漲",
            "光寶：曾在 2026/06/05 列輪漲 / 曾在 2026/06/04 列輪漲",
            "佳必琪：曾在 2026/06/05 列輪漲 / 曾在 2026/06/04 列輪漲"
          ]
        }
      }
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.86%、S&P 500 +0.30%、費半 +5.87%。美股科技鏈偏多，對 其他、電源、封測 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.86%",
            "費半 +5.87%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -3.57%、東京威力科創 +5.34%、Advantest +1.74%。日股科技股續強，通常代表亞洲電子鏈對 其他、電源、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -3.57%",
            "TEL +5.34%",
            "日股偏多"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、電源、封測 輪動，蓋牌比較像 力成、力旺、同欣電。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "力成：同屬 封測 / 同族群 封測",
    ...
    },
    {
      ...
      "analysis": "主軸偏向 其他、電源、封測。 和其他影片重複輪漲最多的是 光寶、矽格、騰輝、佳必琪、東陽。 高出辨識股集中在 盟立、聯亞、聯鈞、穩懋。 當沖股則是 華邦、緯創、聯電，節奏偏快。",
      "tags": [
        "主軸 其他",
        "12 檔重複輪漲",
        "4 檔重複高出",
      ...
      "marketLinks": {
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、電源、封測 輪動，蓋牌比較像 力成、力旺、立敦。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "力成：同屬 封測 / 同族群 封測",
            "力旺：曾在 2026/06/08 列輪漲",
  ...
  "stocks": [
    {
      ...
      "name": "勤誠",
      "bias": "3日共通",
      "gap": "2026/06/08、2026/06/05、2026/06/04",
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/06/08、2026/06/05、2026/06/04 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.131、40 日 %B 約 0.280；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "雙鴻 在 2026/06/08、2026/06/05、2026/06/04 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "網通 / 交換器",
      "note": "智邦 在 2026/06/08、2026/06/05、2026/06/04 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.486、40 日 %B 約 0.311；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "PCB",
      "note": "健鼎 在 2026/06/08、2026/06/05、2026/06/04 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.010、40 日 %B 約 0.195；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "線材 / AI 電源",
      "note": "良維 在 2026/06/08、2026/06/05、2026/06/04 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "佳必琪 在 2026/06/05、2026/06/04 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "騰輝 在 2026/06/05、2026/06/04 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "電源 / 電子權值",
      "note": "光寶 在 2026/06/05、2026/06/04 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.112、40 日 %B 約 -0.122；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/06/05、2026/06/04 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.993、40 日 %B 約 0.455；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "東陽 在 2026/06/05、2026/06/04 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/06/05、2026/06/04 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.560、40 日 %B 約 0.320；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "CCL / PCB",
      "note": "台燿 在 2026/06/05、2026/06/04 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉高出",
      "volume": "自動化 / 機器人",
      "note": "盟立 在 2026/06/08、2026/06/05、2026/06/04 都被列為高出股，TWSE 官方日資料重算後，20 日 %B 約 0.257、40 日 %B 約 0.299；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "高出重複",
          "type": "negative"
    ...
    },
    {
      ...
      "foreign": "交叉高出",
      "volume": "待補產業",
      "note": "英業達 在 2026/06/08、2026/06/05 這組影片裡被列為高出股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "高出重複",
          "type": "negative"
  ...
  "checklist": [
    "先看 2026/06/08 與前兩支影片的交叉輪漲股：勤誠、雙鴻、智邦、健鼎、良維。",
    "高出股 盟立、英業達、聯亞、聯鈞 要和輪漲股分開，不要混成主攻名單。",
    "當沖股 緯創、華邦、聯電 屬快節奏，不適合直接列成首選。",
    "今天盤前先看 智邦、勤誠、貿聯 是否續量。"
  ],
  "risks": [
    {
      "level": "high",
      "title": "影片基準已更新到 2026/06/08、2026/06/05、2026/06/04",
      "detail": "目前基準改用黃清照 YouTube 頻道 /videos 頁面排序，最新三支就是 2026/06/08、2026/06/05、2026/06/04。"
    },
    {
      "level": "medium",
      "title": "有出現三日共通輪漲股",
      "detail": "勤誠、雙鴻、智邦、健鼎、良維 是目前最穩的 3 日共通輪漲股。"
    },
    {
      "level": "medium",
      "title": "高出股與當沖股要拆開處理",
      "detail": "盟立、英業達、聯亞、聯鈞 偏高檔辨識；緯創、華邦、聯電 偏快節奏，和輪漲股不是同一層級。"
    }
  ],
  "bollingerRankings": [
    {
  ...
  "markovModel": {
    "currentState": "主線延續偏多",
    "confidence": 82,
    "takeaway": "2026/06/08 到 2026/06/04 三支影片交叉後，勤誠、雙鴻、智邦、健鼎、良維 是目前最穩的 3 日共通輪漲股；盟立、英業達、聯亞、聯鈞 則偏向高檔辨識。",
    "transitions": [
      {
        "label": "維持主線延續",
        "value": "82%"
    ...
    "drivers": [
      "2026/06/08 輪漲股是 力旺、金像電、勤誠、雙鴻、智邦、健鼎、良維",
      "2026/06/05 對照下，可直接交叉出 勤誠、雙鴻、智邦、健鼎、良維",
      "2026/06/04 對照下，可直接交叉出 勤誠、雙鴻、智邦、健鼎、良維"
    ]
  },
  "monteCarloScenarios": [
    {
      ...
      "name": "智邦",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 913 - 1844",
      "stopLoss": "3% 停損命中率 90%",
      "takeProfit": "8% 停利命中率 63%",
      "drawdown": "模擬最大回撤中位數 34.7%",
      "note": "智邦 是這版布林與重複輪漲交集最漂亮的一檔。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
