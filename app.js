const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.29.0900",
    "lastUpdated": "2026/05/29 09:00",
    "lastAutomationSync": "2026/05/29 09:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.91%、S&P 500 +0.58%、費半 +0.97%。美股科技鏈偏多，對 其他、被動元件、封測 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.91%",
            "費半 +0.97%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +1.12%、東京威力科創 +0.67%、Advantest +0.11%。日股科技股續強，通常代表亞洲電子鏈對 其他、被動元件、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +1.12%",
            "TEL +0.67%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +1.88%、Samsung +4.34%、SK Hynix +3.23%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +1.88%",
            "Samsung +4.34%",
            "Hynix +3.23%"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.91%、S&P 500 +0.58%、費半 +0.97%。美股科技鏈偏多，對 封測、其他、被動元件 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.91%",
            "費半 +0.97%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +1.12%、東京威力科創 +0.67%、Advantest +0.11%。日股科技股續強，通常代表亞洲電子鏈對 封測、其他、被動元件 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +1.12%",
            "TEL +0.67%",
            "日股偏多"
  ...
  "stocks": [
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "感測 / 封測",
      "note": "同欣電 在 2026/05/27、2026/05/26 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.952、40 日 %B 約 0.890；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
  ...
  "monteCarloScenarios": [
    ...
    },
    {
      ...
      "name": "奇鋐",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 1184 - 2250",
      "stopLoss": "3% 停損命中率 84%",
      "takeProfit": "8% 停利命中率 68%",
      "drawdown": "模擬最大回撤中位數 32.7%",
