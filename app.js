const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.20.0900",
    "lastUpdated": "2026/05/20 09:00",
    "lastAutomationSync": "2026/05/20 09:00",
    "videoBasis": "2026/05/19、2026/05/18、2026/05/15"
  },
  "marketMood": {
    "label": "主線延續偏多",
    "summary": "2026/05/19 到 2026/05/15 三支影片交叉後，國巨、勤誠、健鼎、貿聯、光寶、日電貿、超豐、富鼎、矽格、良維 是目前最穩的 3 日共通輪漲股；尖點、聯亞、穩懋、盟立 則偏向高檔辨識。",
    "score": 82,
    "openingPlan": "先看 啟碁、國巨、勤誠 是否續強"
  },
  "headlines": [
    {
      "tone": "positive",
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -1.47%、東京威力科創 -3.35%、Advantest +0.59%。日股科技股轉弱，通常代表亞洲電子鏈對 PCB、被動元件、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -1.47%",
            "TEL -3.35%",
            "日股轉弱"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI -1.32%、Samsung +0.73%、SK Hynix -1.26%。韓股電子權值轉弱，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI -1.32%",
            "Samsung +0.73%",
            "Hynix -1.26%"
    ...
    },
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -1.47%、東京威力科創 -3.35%、Advantest +0.59%。日股科技股轉弱，通常代表亞洲電子鏈對 被動元件、封測、PCB 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -1.47%",
            "TEL -3.35%",
            "日股轉弱"
    ...
    },
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -1.47%、東京威力科創 -3.35%、Advantest +0.59%。日股科技股轉弱，通常代表亞洲電子鏈對 被動元件、封測、光學權值 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -1.47%",
            "TEL -3.35%",
            "日股轉弱"
  ...
  "stocks": [
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "網通",
      "note": "啟碁 在 2026/05/19、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.660、40 日 %B 約 0.584；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "國巨 在 2026/05/19、2026/05/18、2026/05/15 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.994、40 日 %B 約 0.791；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "奇鋐",
      "bias": "2日共通",
      "gap": "2026/05/19、2026/05/15",
      "foreign": "交叉輪漲",
      "volume": "AI 散熱 / 伺服器",
      "note": "奇鋐 在 2026/05/19、2026/05/15 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.462、40 日 %B 約 0.378；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "PCB",
      "note": "健鼎 在 2026/05/19、2026/05/18、2026/05/15 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.658、40 日 %B 約 0.523；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/05/19、2026/05/18、2026/05/15 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.385、40 日 %B 約 0.314；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "電源 / 電子權值",
      "note": "光寶 在 2026/05/19、2026/05/18、2026/05/15 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.616、40 日 %B 約 0.678；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "PCB / 車用",
      "note": "敬鵬 在 2026/05/19、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.456、40 日 %B 約 0.373；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "被動元件通路",
      "note": "日電貿 在 2026/05/19、2026/05/18、2026/05/15 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.894、40 日 %B 約 0.859；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "超豐 在 2026/05/19、2026/05/18、2026/05/15 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.859、40 日 %B 約 0.935；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "MOSFET",
      "note": "富鼎 在 2026/05/19、2026/05/18、2026/05/15 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.581、40 日 %B 約 0.401；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/05/19、2026/05/18、2026/05/15 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.960、40 日 %B 約 0.648；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "線材 / AI 電源",
      "note": "良維 在 2026/05/19、2026/05/18、2026/05/15 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
  ...
  "checklist": [
    "先看 2026/05/19 與前兩支影片的交叉輪漲股：國巨、勤誠、健鼎、貿聯、光寶、日電貿、超豐、富鼎、矽格、良維。",
    "高出股 尖點、聯亞、穩懋、盟立 要和輪漲股分開，不要混成主攻名單。",
    "當沖股 聯電、群創 屬快節奏，不適合直接列成首選。",
    "今天盤前先看 光寶、健鼎、富鼎 是否續量。"
  ],
  "risks": [
    {
      "level": "high",
      "title": "影片基準已更新到 2026/05/19、2026/05/18、2026/05/15",
      "detail": "目前基準改用黃清照 YouTube 頻道 /videos 頁面排序，最新三支就是 2026/05/19、2026/05/18、2026/05/15。"
    },
    {
      "level": "medium",
      "title": "有出現三日共通輪漲股",
      "detail": "國巨、勤誠、健鼎、貿聯、光寶、日電貿、超豐、富鼎、矽格、良維 是目前最穩的 3 日共通輪漲股。"
    },
    {
      "level": "medium",
      "title": "高出股與當沖股要拆開處理",
      "detail": "尖點、聯亞、穩懋、盟立 偏高檔辨識；聯電、群創 偏快節奏，和輪漲股不是同一層級。"
    }
  ],
  "bollingerRankings": [
    {
  ...
  "markovModel": {
    "currentState": "主線延續偏多",
    "confidence": 82,
    "takeaway": "2026/05/19 到 2026/05/15 三支影片交叉後，國巨、勤誠、健鼎、貿聯、光寶、日電貿、超豐、富鼎、矽格、良維 是目前最穩的 3 日共通輪漲股；尖點、聯亞、穩懋、盟立 則偏向高檔辨識。",
    "transitions": [
      {
        "label": "維持主線延續",
        "value": "82%"
    ...
    "drivers": [
      "2026/05/19 輪漲股是 啟碁、國巨、金像電、勤誠、奇鋐、健鼎、貿聯、光寶",
      "2026/05/18 對照下，可直接交叉出 啟碁、國巨、勤誠、健鼎、貿聯、光寶、敬鵬、日電貿、立隆、超豐、富鼎、矽格、良維",
      "2026/05/15 對照下，可直接交叉出 國巨、勤誠、奇鋐、健鼎、貿聯、光寶、日電貿、超豐、富鼎、矽格、良維"
    ]
  },
  "monteCarloScenarios": [
    {
      ...
      "name": "光寶",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 130 - 200",
      "stopLoss": "3% 停損命中率 87%",
      "takeProfit": "8% 停利命中率 58%",
      "drawdown": "模擬最大回撤中位數 25.2%",
    ...
    },
    {
      ...
      "name": "健鼎",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 278 - 453",
      "stopLoss": "3% 停損命中率 81%",
      "takeProfit": "8% 停利命中率 56%",
      "drawdown": "模擬最大回撤中位數 22.8%",
    ...
    },
    {
      ...
      "name": "富鼎",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 71 - 114",
      "stopLoss": "3% 停損命中率 85%",
      "takeProfit": "8% 停利命中率 52%",
