const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.05.0900",
    "lastUpdated": "2026/06/05 09:00",
    "lastAutomationSync": "2026/06/05 09:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.09%、S&P 500 +0.41%、費半 -2.10%。美股科技鏈轉保守，對 其他、電源、封測 這組主軸會增加開高走低風險。",
          "signals": [
            "Nasdaq -0.09%",
            "費半 -2.10%",
            "電子偏保守"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -3.01%、東京威力科創 -6.52%、Advantest -4.88%。日股科技股轉弱，通常代表亞洲電子鏈對 其他、電源、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -3.01%",
            "TEL -6.52%",
            "日股轉弱"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI -7.38%、Samsung -6.12%、SK Hynix -8.05%。韓股電子權值轉弱，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI -7.38%",
            "Samsung -6.12%",
            "Hynix -8.05%"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.09%、S&P 500 +0.41%、費半 -2.10%。美股科技鏈轉保守，對 其他、封測、電源 這組主軸會增加開高走低風險。",
          "signals": [
            "Nasdaq -0.09%",
            "費半 -2.10%",
            "電子偏保守"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -3.01%、東京威力科創 -6.52%、Advantest -4.88%。日股科技股轉弱，通常代表亞洲電子鏈對 其他、封測、電源 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -3.01%",
            "TEL -6.52%",
            "日股轉弱"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.09%、S&P 500 +0.41%、費半 -2.10%。美股科技鏈轉保守，對 其他、AI PC、伺服器 這組主軸會增加開高走低風險。",
          "signals": [
            "Nasdaq -0.09%",
            "費半 -2.10%",
            "電子偏保守"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -3.01%、東京威力科創 -6.52%、Advantest -4.88%。日股科技股轉弱，通常代表亞洲電子鏈對 其他、AI PC、伺服器 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -3.01%",
            "TEL -6.52%",
            "日股轉弱"
  ...
  "stocks": [
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/06/04、2026/06/03、2026/06/02 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.560、40 日 %B 約 0.320；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
  ...
  "monteCarloScenarios": [
    {
      ...
      "name": "貿聯",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 1066 - 2211",
      "stopLoss": "3% 停損命中率 88%",
      "takeProfit": "8% 停利命中率 65%",
      "drawdown": "模擬最大回撤中位數 37.2%",
    ...
    },
    {
      ...
      "name": "智邦",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 940 - 1801",
      "stopLoss": "3% 停損命中率 88%",
      "takeProfit": "8% 停利命中率 68%",
      "drawdown": "模擬最大回撤中位數 35.3%",
