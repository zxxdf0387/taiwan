const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.20.2200",
    "lastUpdated": "2026/05/20 22:00",
    "lastAutomationSync": "2026/05/20 22:00",
    "videoBasis": "2026/05/20、2026/05/19、2026/05/18"
  },
  "marketMood": {
    "label": "主線延續偏多",
    "summary": "2026/05/20 到 2026/05/18 三支影片交叉後，日電貿、立隆、超豐、富鼎、矽格、良維、光寶、國巨、勤誠、健鼎、貿聯 是目前最穩的 3 日共通輪漲股；盟立、所羅門、尖點、聯亞、穩懋 則偏向高檔辨識。",
    "score": 82,
    "openingPlan": "先看 同欣電、日電貿、立隆 是否續量"
  },
  "headlines": [
    {
      "tone": "positive",
      "title": "最新影片：2026/05/20",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.49%、S&P 500 +0.36%、費半 +2.98%。美股科技鏈偏多，對 被動元件、其他、封測 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.49%",
            "費半 +2.98%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -1.23%、東京威力科創 -2.25%、Advantest +1.32%。日股科技股轉弱，通常代表亞洲電子鏈對 被動元件、其他、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -1.23%",
            "TEL -2.25%",
            "日股轉弱"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI -0.86%、Samsung +0.18%、SK Hynix 0.00%。韓股電子權值中性，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI -0.86%",
            "Samsung +0.18%",
            "Hynix 0.00%"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 被動元件、其他、封測 輪動，蓋牌比較像 啟碁、敬鵬、力成。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "啟碁：曾在 2026/05/19 列輪漲 / 曾在 2026/05/18 列輪漲",
            "敬鵬：曾在 2026/05/19 列輪漲 / 曾在 2026/05/18 列輪漲",
            "力成：同屬 封測 / 同族群 封測"
          ]
        }
      }
    },
    {
      ...
      "analysis": "主軸偏向 PCB、被動元件、封測。 和其他影片重複輪漲最多的是 啟碁、國巨、勤誠、奇鋐、健鼎。 高出辨識股集中在 尖點、聯亞、穩懋、盟立。 當沖股則是 聯電、群創、頎邦，節奏偏快。",
      "tags": [
        "主軸 PCB",
        "14 檔重複輪漲",
        "5 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.49%、S&P 500 +0.36%、費半 +2.98%。美股科技鏈偏多，對 PCB、被動元件、封測 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.49%",
            "費半 +2.98%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -1.23%、東京威力科創 -2.25%、Advantest +1.32%。日股科技股轉弱，通常代表亞洲電子鏈對 PCB、被動元件、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -1.23%",
            "TEL -2.25%",
            "日股轉弱"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 PCB、被動元件、封測 輪動，蓋牌比較像 同欣電、智邦、華通。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "同欣電：曾在 2026/05/20 列輪漲 / 曾在 2026/05/18 列輪漲",
            "智邦：曾在 2026/05/20 列輪漲 / 曾在 2026/05/18 列輪漲",
            "華通：曾在 2026/05/20 列高出 / 同屬 PCB"
          ]
        }
      }
    },
    {
      "tone": "neutral",
      "title": "再前一支影片：2026/05/18",
      "summary": "2026/05/18 這支影片把 日電貿、立隆、矽格、超豐、富鼎、光寶、良維、敬鵬、同欣電、啟碁、國巨、智邦、勤誠、健鼎、技嘉、貿聯列輪漲，盟立、上銀、景碩、尖點、聯亞、穩懋列高出，聯電、群創、華邦列當沖。",
      "meta": "16 檔輪漲 ｜ 6 檔高出 ｜ 3 檔當沖",
      "analysis": "主軸偏向 被動元件、封測、PCB。 和其他影片重複輪漲最多的是 日電貿、立隆、矽格、超豐、富鼎。 高出辨識股集中在 盟立、尖點、聯亞、穩懋。 當沖股則是 聯電、群創，節奏偏快。",
      "tags": [
        "主軸 被動元件",
        "15 檔重複輪漲",
        "4 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.49%、S&P 500 +0.36%、費半 +2.98%。美股科技鏈偏多，對 被動元件、封測、PCB 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.49%",
            "費半 +2.98%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -1.23%、東京威力科創 -2.25%、Advantest +1.32%。日股科技股轉弱，通常代表亞洲電子鏈對 被動元件、封測、PCB 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -1.23%",
            "TEL -2.25%",
            "日股轉弱"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 被動元件、封測、PCB 輪動，蓋牌比較像 奇鋐、金像電、華通。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "奇鋐：曾在 2026/05/20 列輪漲 / 曾在 2026/05/19 列輪漲",
  ...
  "stocks": [
    {
      ...
      "name": "同欣電",
      "bias": "2日共通",
      "gap": "2026/05/20、2026/05/18",
      "foreign": "交叉輪漲",
      "volume": "感測 / 封測",
      "note": "同欣電 在 2026/05/20、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.952、40 日 %B 約 0.890；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "日電貿",
      "bias": "3日共通",
      "gap": "2026/05/20、2026/05/19、2026/05/18",
      "foreign": "交叉輪漲",
      "volume": "被動元件通路",
      "note": "日電貿 在 2026/05/20、2026/05/19、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.894、40 日 %B 約 0.859；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "立隆 在 2026/05/20、2026/05/19、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.736、40 日 %B 約 0.523；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "超豐 在 2026/05/20、2026/05/19、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.859、40 日 %B 約 0.698；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "MOSFET",
      "note": "富鼎 在 2026/05/20、2026/05/19、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.581、40 日 %B 約 0.391；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/05/20、2026/05/19、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.960、40 日 %B 約 0.648；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "線材 / AI 電源",
      "note": "良維 在 2026/05/20、2026/05/19、2026/05/18 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "電源 / 電子權值",
      "note": "光寶 在 2026/05/20、2026/05/19、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.616、40 日 %B 約 0.678；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "國巨 在 2026/05/20、2026/05/19、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.994、40 日 %B 約 0.791；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "網通 / 交換器",
      "note": "智邦 在 2026/05/20、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.466、40 日 %B 約 0.378；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/05/20、2026/05/19、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.459、40 日 %B 約 0.415；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "奇鋐",
      "bias": "2日共通",
      "gap": "2026/05/20、2026/05/19",
      "foreign": "交叉輪漲",
      "volume": "AI 散熱 / 伺服器",
      "note": "奇鋐 在 2026/05/20、2026/05/19 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.462、40 日 %B 約 0.378；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "PCB",
      "note": "健鼎 在 2026/05/20、2026/05/19、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.658、40 日 %B 約 0.523；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/05/20、2026/05/19、2026/05/18 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.385、40 日 %B 約 0.314；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
  ...
  "checklist": [
    "先看 2026/05/20 與前兩支影片的交叉輪漲股：日電貿、立隆、超豐、富鼎、矽格、良維、光寶、國巨、勤誠、健鼎、貿聯。",
    "高出股 盟立、所羅門、尖點、聯亞、穩懋 要和輪漲股分開，不要混成主攻名單。",
    "當沖股 聯電、群創、頎邦 屬快節奏，不適合直接列成首選。",
    "今天盤前先看 光寶、健鼎、富鼎 是否續量。"
  ],
  "risks": [
    {
      "level": "high",
      "title": "影片基準已更新到 2026/05/20、2026/05/19、2026/05/18",
      "detail": "目前基準改用黃清照 YouTube 頻道 /videos 頁面排序，最新三支就是 2026/05/20、2026/05/19、2026/05/18。"
    },
    {
      "level": "medium",
      "title": "有出現三日共通輪漲股",
      "detail": "日電貿、立隆、超豐、富鼎、矽格、良維、光寶、國巨、勤誠、健鼎、貿聯 是目前最穩的 3 日共通輪漲股。"
    },
    {
      "level": "medium",
      "title": "高出股與當沖股要拆開處理",
      "detail": "盟立、所羅門、尖點、聯亞、穩懋 偏高檔辨識；聯電、群創、頎邦 偏快節奏，和輪漲股不是同一層級。"
    }
  ],
  "bollingerRankings": [
    {
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/05/20 收盤",
      "summary": "富鼎 用 TWSE 官方日資料重算後，20 日 %B 約 0.581、40 日 %B 約 0.391；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.581",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/05/20 收盤",
      "summary": "立隆 用 TWSE 官方日資料重算後，20 日 %B 約 0.736、40 日 %B 約 0.523；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.736",
        "40日不過熱"
  ...
  "markovModel": {
    "currentState": "主線延續偏多",
    "confidence": 82,
    "takeaway": "2026/05/20 到 2026/05/18 三支影片交叉後，日電貿、立隆、超豐、富鼎、矽格、良維、光寶、國巨、勤誠、健鼎、貿聯 是目前最穩的 3 日共通輪漲股；盟立、所羅門、尖點、聯亞、穩懋 則偏向高檔辨識。",
    "transitions": [
      {
        "label": "維持主線延續",
        "value": "82%"
    ...
    "drivers": [
      "2026/05/20 輪漲股是 同欣電、日電貿、立隆、立敦、超豐、富鼎、矽格、良維",
      "2026/05/19 對照下，可直接交叉出 日電貿、立隆、超豐、富鼎、矽格、良維、光寶、國巨、勤誠、奇鋐、健鼎、貿聯",
      "2026/05/18 對照下，可直接交叉出 同欣電、日電貿、立隆、超豐、富鼎、矽格、良維、光寶、國巨、智邦、勤誠、健鼎、貿聯"
    ]
  },
  "monteCarloScenarios": [
    {
      ...
      "name": "光寶",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 158 - 217",
      "stopLoss": "3% 停損命中率 67%",
      "takeProfit": "8% 停利命中率 72%",
      "drawdown": "模擬最大回撤中位數 13.0%",
    ...
    },
    {
      ...
      "name": "健鼎",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 286 - 436",
      "stopLoss": "3% 停損命中率 87%",
      "takeProfit": "8% 停利命中率 56%",
      "drawdown": "模擬最大回撤中位數 23.0%",
