const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.07.2200",
    "lastUpdated": "2026/06/07 22:00",
    "lastAutomationSync": "2026/06/07 22:00",
    "videoBasis": "2026/06/05、2026/06/04、2026/06/03"
  },
  "marketMood": {
    "label": "主線延續偏多",
    "summary": "2026/06/05 到 2026/06/03 三支影片交叉後，佳必琪、騰輝、光寶、矽格、東陽、雙鴻、貿聯、台燿、勤誠、智邦、良維 是目前最穩的 3 日共通輪漲股；英業達、盟立、聯亞、聯鈞、穩懋 則偏向高檔辨識。",
    "score": 82,
    "openingPlan": "先看 佳必琪、騰輝、光寶 是否續強"
  },
  "headlines": [
    {
      "tone": "positive",
      "title": "最新影片：2026/06/05",
      ...
      "analysis": "主軸偏向 其他、電源、封測。 和其他影片重複輪漲最多的是 佳必琪、騰輝、光寶、矽格、東陽。 高出辨識股集中在 英業達、盟立、聯亞、聯鈞。 當沖股則是 緯創、聯電，節奏偏快。",
      "tags": [
        "主軸 其他",
        "12 檔重複輪漲",
        "5 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -4.18%、S&P 500 -2.64%、費半 -10.44%。美股科技鏈轉保守，對 其他、電源、封測 這組主軸會增加開高走低風險。",
          "signals": [
            "Nasdaq -4.18%",
            "費半 -10.44%",
            "電子偏保守"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -1.31%、東京威力科創 -6.61%、Advantest -4.99%。日股科技股轉弱，通常代表亞洲電子鏈對 其他、電源、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -1.31%",
            "TEL -6.61%",
            "日股轉弱"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI -5.54%、Samsung -6.40%、SK Hynix -9.92%。韓股電子權值轉弱，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI -5.54%",
            "Samsung -6.40%",
            "Hynix -9.92%"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、電源、封測 輪動，蓋牌比較像 奇鋐、長榮航、超豐。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "奇鋐：曾在 2026/06/04 列輪漲 / 曾在 2026/06/03 列輪漲",
            "長榮航：曾在 2026/06/04 列輪漲 / 曾在 2026/06/03 列輪漲",
            "超豐：曾在 2026/06/03 列輪漲 / 同屬 封測"
          ]
        }
      }
    },
    {
      ...
      "marketLinks": {
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、電源、封測 輪動，蓋牌比較像 超豐、力成、立敦。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "超豐：曾在 2026/06/03 列輪漲 / 同屬 封測",
            "力成：同屬 封測 / 同族群 封測",
    ...
    {
      "tone": "neutral",
      "title": "再前一支影片：2026/06/03",
      "summary": "2026/06/03 這支影片把 光寶、矽格、神達、騰輝、佳必琪、長榮航、超豐、東陽、雙鴻、貿聯、奇鋐、台燿、勤誠、智邦、良維列輪漲，英業達、盟立、群創、聯亞、聯鈞、金居、穩懋列高出，華邦、緯創、聯電列當沖。",
      "meta": "15 檔輪漲 ｜ 7 檔高出 ｜ 3 檔當沖",
      "analysis": "主軸偏向 其他、封測、電源。 和其他影片重複輪漲最多的是 光寶、矽格、騰輝、佳必琪、長榮航。 高出辨識股集中在 英業達、盟立、群創、聯亞。 當沖股則是 華邦、緯創、聯電，節奏偏快。",
      "tags": [
        "主軸 其他",
        "13 檔重複輪漲",
        "7 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -4.18%、S&P 500 -2.64%、費半 -10.44%。美股科技鏈轉保守，對 其他、封測、電源 這組主軸會增加開高走低風險。",
          "signals": [
            "Nasdaq -4.18%",
            "費半 -10.44%",
            "電子偏保守"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -1.31%、東京威力科創 -6.61%、Advantest -4.99%。日股科技股轉弱，通常代表亞洲電子鏈對 其他、封測、電源 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -1.31%",
            "TEL -6.61%",
            "日股轉弱"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、封測、電源 輪動，蓋牌比較像 健鼎、力成、立敦。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "健鼎：曾在 2026/06/05 列輪漲 / 曾在 2026/06/04 列輪漲",
            "力成：同屬 封測 / 同族群 封測",
            "立敦：曾在 2026/06/05 列輪漲"
          ]
        }
  ...
  "stocks": [
    {
      ...
      "name": "佳必琪",
      "bias": "3日共通",
      "gap": "2026/06/05、2026/06/04、2026/06/03",
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "佳必琪 在 2026/06/05、2026/06/04、2026/06/03 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "騰輝 在 2026/06/05、2026/06/04、2026/06/03 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "電源 / 電子權值",
      "note": "光寶 在 2026/06/05、2026/06/04、2026/06/03 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.112、40 日 %B 約 -0.122；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/06/05、2026/06/04、2026/06/03 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.993、40 日 %B 約 0.455；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "東陽 在 2026/06/05、2026/06/04、2026/06/03 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "雙鴻 在 2026/06/05、2026/06/04、2026/06/03 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/06/05、2026/06/04、2026/06/03 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.560、40 日 %B 約 0.320；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "CCL / PCB",
      "note": "台燿 在 2026/06/05、2026/06/04、2026/06/03 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/06/05、2026/06/04、2026/06/03 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.131、40 日 %B 約 0.280；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "網通 / 交換器",
      "note": "智邦 在 2026/06/05、2026/06/04、2026/06/03 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.486、40 日 %B 約 0.311；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "健鼎",
      "bias": "2日共通",
      "gap": "2026/06/05、2026/06/04",
      "foreign": "交叉輪漲",
      "volume": "PCB",
      "note": "健鼎 在 2026/06/05、2026/06/04 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.010、40 日 %B 約 0.195；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "線材 / AI 電源",
      "note": "良維 在 2026/06/05、2026/06/04、2026/06/03 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
  ...
  "checklist": [
    "先看 2026/06/05 與前兩支影片的交叉輪漲股：佳必琪、騰輝、光寶、矽格、東陽、雙鴻、貿聯、台燿、勤誠、智邦、良維。",
    "高出股 英業達、盟立、聯亞、聯鈞、穩懋 要和輪漲股分開，不要混成主攻名單。",
    "當沖股 緯創、聯電 屬快節奏，不適合直接列成首選。",
    "今天盤前先看 貿聯、智邦、矽格 是否續量。"
  ],
  "risks": [
    {
      "level": "high",
      "title": "影片基準已更新到 2026/06/05、2026/06/04、2026/06/03",
      "detail": "目前基準改用黃清照 YouTube 頻道 /videos 頁面排序，最新三支就是 2026/06/05、2026/06/04、2026/06/03。"
    },
    {
      "level": "medium",
      "title": "有出現三日共通輪漲股",
      "detail": "佳必琪、騰輝、光寶、矽格、東陽、雙鴻、貿聯、台燿、勤誠、智邦、良維 是目前最穩的 3 日共通輪漲股。"
    },
    {
      "level": "medium",
      "title": "高出股與當沖股要拆開處理",
      "detail": "英業達、盟立、聯亞、聯鈞、穩懋 偏高檔辨識；緯創、聯電 偏快節奏，和輪漲股不是同一層級。"
    }
  ],
  "bollingerRankings": [
    {
  ...
  "markovModel": {
    "currentState": "主線延續偏多",
    "confidence": 82,
    "takeaway": "2026/06/05 到 2026/06/03 三支影片交叉後，佳必琪、騰輝、光寶、矽格、東陽、雙鴻、貿聯、台燿、勤誠、智邦、良維 是目前最穩的 3 日共通輪漲股；英業達、盟立、聯亞、聯鈞、穩懋 則偏向高檔辨識。",
    "transitions": [
      {
        "label": "維持主線延續",
        "value": "82%"
    ...
    "drivers": [
      "2026/06/05 輪漲股是 立敦、興勤、佳必琪、騰輝、光寶、矽格、東鹼、東陽",
      "2026/06/04 對照下，可直接交叉出 佳必琪、騰輝、光寶、矽格、東陽、雙鴻、貿聯、台燿、勤誠、智邦、健鼎、良維",
      "2026/06/03 對照下，可直接交叉出 佳必琪、騰輝、光寶、矽格、東陽、雙鴻、貿聯、台燿、勤誠、智邦、良維"
    ]
  },
  "monteCarloScenarios": [
    {
      ...
      "name": "貿聯",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 1004 - 2076",
      "stopLoss": "3% 停損命中率 91%",
      "takeProfit": "8% 停利命中率 66%",
      "drawdown": "模擬最大回撤中位數 38.4%",
    ...
    },
    {
      ...
      "name": "矽格",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 103 - 180",
      "stopLoss": "3% 停損命中率 85%",
      "takeProfit": "8% 停利命中率 63%",
      "drawdown": "模擬最大回撤中位數 27.5%",
