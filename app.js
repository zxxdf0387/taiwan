const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.02.0900",
    "lastUpdated": "2026/06/02 09:00",
    "lastAutomationSync": "2026/06/02 09:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.42%、S&P 500 +0.26%、費半 +0.50%。美股科技鏈中性，對 其他、AI PC、電源 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq +0.42%",
            "費半 +0.50%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.05%、東京威力科創 -0.19%、Advantest -0.62%。日股科技股震盪，通常代表亞洲電子鏈對 其他、AI PC、電源 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.05%",
            "TEL -0.19%",
            "日股中性"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +3.31%、Samsung +3.44%、SK Hynix -0.34%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +3.31%",
            "Samsung +3.44%",
            "Hynix -0.34%"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.42%、S&P 500 +0.26%、費半 +0.50%。美股科技鏈中性，對 其他、封測、線纜補漲 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq +0.42%",
            "費半 +0.50%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.05%、東京威力科創 -0.19%、Advantest -0.62%。日股科技股震盪，通常代表亞洲電子鏈對 其他、封測、線纜補漲 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.05%",
            "TEL -0.19%",
            "日股中性"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.42%、S&P 500 +0.26%、費半 +0.50%。美股科技鏈中性，對 其他、被動元件、封測 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq +0.42%",
            "費半 +0.50%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.05%、東京威力科創 -0.19%、Advantest -0.62%。日股科技股震盪，通常代表亞洲電子鏈對 其他、被動元件、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.05%",
            "TEL -0.19%",
            "日股中性"
  ...
  "stocks": [
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "伺服器 / 車電",
      "note": "神達 在 2026/06/01、2026/05/29 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.139、40 日 %B 約 -0.080；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
  ...
  "monteCarloScenarios": [
    {
      ...
      "name": "貿聯",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 1015 - 2127",
      "stopLoss": "3% 停損命中率 88%",
      "takeProfit": "8% 停利命中率 62%",
      "drawdown": "模擬最大回撤中位數 36.2%",
    ...
    },
    {
      ...
      "name": "奇鋐",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 1368 - 2535",
      "stopLoss": "3% 停損命中率 83%",
      "takeProfit": "8% 停利命中率 68%",
      "drawdown": "模擬最大回撤中位數 30.4%",
    ...
    },
    {
      ...
      "name": "技嘉",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 160 - 271",
      "stopLoss": "3% 停損命中率 85%",
      "takeProfit": "8% 停利命中率 66%",
      "drawdown": "模擬最大回撤中位數 26.0%",
