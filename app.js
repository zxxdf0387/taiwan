const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.28.0900",
    "lastUpdated": "2026/05/28 09:00",
    "lastAutomationSync": "2026/05/28 09:00",
    "videoBasis": "2026/05/27、2026/05/26、2026/05/25"
  },
  "marketMood": {
    "label": "主線延續偏多",
    "summary": "2026/05/27 到 2026/05/25 三支影片交叉後，立隆、超豐、同欣電、佳必琪、矽格、良維、安勤、奇鋐、貿聯、台燿、勤誠 是目前最穩的 3 日共通輪漲股；盟立、直得續、尖點、聯亞、景碩 則偏向高檔辨識。",
    "score": 82,
    "openingPlan": "先看 立隆、超豐、同欣電 是否續強"
  },
  "headlines": [
    {
      "tone": "positive",
      "title": "最新影片：2026/05/27",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.07%、S&P 500 +0.02%、費半 -1.07%。美股科技鏈中性，對 封測、其他、被動元件 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq +0.07%",
            "費半 -1.07%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.26%、東京威力科創 -0.97%、Advantest -0.68%。日股科技股轉弱，通常代表亞洲電子鏈對 封測、其他、被動元件 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.26%",
            "TEL -0.97%",
            "日股轉弱"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI -0.45%、Samsung -1.30%、SK Hynix +0.85%。韓股電子權值中性，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI -0.45%",
            "Samsung -1.30%",
            "Hynix +0.85%"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 封測、其他、被動元件 輪動，蓋牌比較像 力成、光寶、國巨。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "力成：曾在 2026/05/26 列輪漲 / 曾在 2026/05/25 列輪漲",
            "光寶：曾在 2026/05/26 列輪漲 / 曾在 2026/05/25 列輪漲",
            "國巨：曾在 2026/05/25 列輪漲 / 同屬 被動元件"
          ]
        }
      }
    },
    {
      ...
      "analysis": "主軸偏向 封測、其他、被動元件。 和其他影片重複輪漲最多的是 立隆、富鼎、超豐、同欣電、光寶。 高出辨識股集中在 盟立、直得續、尖點、聯亞。 當沖股則是 聯電、華邦、頎邦，節奏偏快。",
      "tags": [
        "主軸 封測",
        "15 檔重複輪漲",
        "6 檔重複高出",
      ...
      "marketLinks": {
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 封測、其他、被動元件 輪動，蓋牌比較像 國巨、日電貿、尼克森。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "國巨：曾在 2026/05/25 列輪漲 / 同屬 被動元件",
            "日電貿：同屬 被動元件 / 同族群 被動元件",
            "尼克森：同屬 被動元件 / 同族群 被動元件"
          ]
        }
      }
    },
    {
      "tone": "neutral",
      "title": "再前一支影片：2026/05/25",
      "summary": "2026/05/25 這支影片把 富鼎、超豐、同欣電、光寶、佳必琪、矽格、良維、緯創、安勤、國巨、立隆、力成、奇鋐、貿聯、台燿、勤誠列輪漲，盟立、所羅門續、尖點、聯亞、景碩、穩懋列高出，聯電、群創、頎邦列當沖。",
      "meta": "16 檔輪漲 ｜ 6 檔高出 ｜ 3 檔當沖",
      "analysis": "主軸偏向 封測、其他、被動元件。 和其他影片重複輪漲最多的是 富鼎、超豐、同欣電、光寶、佳必琪。 高出辨識股集中在 盟立、尖點、聯亞、景碩。 當沖股則是 聯電、頎邦，節奏偏快。",
      "tags": [
        "主軸 封測",
        "14 檔重複輪漲",
        "5 檔重複高出",
      ...
      "marketLinks": {
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 封測、其他、被動元件 輪動，蓋牌比較像 健鼎、台半、日電貿。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "健鼎：曾在 2026/05/27 列輪漲 / 曾在 2026/05/26 列輪漲",
            "台半：曾在 2026/05/27 列當沖 / 曾在 2026/05/26 列輪漲",
            "日電貿：同屬 被動元件 / 同族群 被動元件"
          ]
        }
      }
  ...
  "stocks": [
    {
      ...
      "name": "富鼎",
      "bias": "2日共通",
      "gap": "2026/05/27、2026/05/26、2026/05/25",
      "foreign": "交叉輪漲",
      "volume": "MOSFET",
      "note": "富鼎 在 2026/05/26、2026/05/25 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.581、40 日 %B 約 0.401；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "立隆 在 2026/05/27、2026/05/26、2026/05/25 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.736、40 日 %B 約 0.523；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "超豐 在 2026/05/27、2026/05/26、2026/05/25 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.859、40 日 %B 約 0.935；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "感測 / 封測",
      "note": "同欣電 在 2026/05/27、2026/05/26、2026/05/25 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.952、40 日 %B 約 0.890；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "佳必琪 在 2026/05/27、2026/05/26、2026/05/25 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/05/27、2026/05/26、2026/05/25 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.960、40 日 %B 約 0.648；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "線材 / AI 電源",
      "note": "良維 在 2026/05/27、2026/05/26、2026/05/25 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "安勤 在 2026/05/27、2026/05/26、2026/05/25 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "PCB",
      "note": "健鼎 在 2026/05/27、2026/05/26 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.658、40 日 %B 約 0.523；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 散熱 / 伺服器",
      "note": "奇鋐 在 2026/05/27、2026/05/26、2026/05/25 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.462、40 日 %B 約 0.378；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/05/27、2026/05/26、2026/05/25 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.385、40 日 %B 約 0.314；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "CCL / PCB",
      "note": "台燿 在 2026/05/27、2026/05/26、2026/05/25 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/05/27、2026/05/26、2026/05/25 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.459、40 日 %B 約 0.415；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "電源 / 電子權值",
      "note": "光寶 在 2026/05/26、2026/05/25 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.616、40 日 %B 約 0.678；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
  ...
  "checklist": [
    "先看 2026/05/27 與前兩支影片的交叉輪漲股：立隆、超豐、同欣電、佳必琪、矽格、良維、安勤、奇鋐、貿聯、台燿、勤誠。",
    "高出股 盟立、直得續、尖點、聯亞、景碩 要和輪漲股分開，不要混成主攻名單。",
    "當沖股 聯電、華邦、頎邦 屬快節奏，不適合直接列成首選。",
    "今天盤前先看 勤誠、奇鋐、立隆 是否續量。"
  ],
  "risks": [
    {
      "level": "high",
      "title": "影片基準已更新到 2026/05/27、2026/05/26、2026/05/25",
      "detail": "目前基準改用黃清照 YouTube 頻道 /videos 頁面排序，最新三支就是 2026/05/27、2026/05/26、2026/05/25。"
    },
    {
      "level": "medium",
      "title": "有出現三日共通輪漲股",
      "detail": "立隆、超豐、同欣電、佳必琪、矽格、良維、安勤、奇鋐、貿聯、台燿、勤誠 是目前最穩的 3 日共通輪漲股。"
    },
    {
      "level": "medium",
      "title": "高出股與當沖股要拆開處理",
      "detail": "盟立、直得續、尖點、聯亞、景碩 偏高檔辨識；聯電、華邦、頎邦 偏快節奏，和輪漲股不是同一層級。"
    }
  ],
  "bollingerRankings": [
    {
  ...
  "markovModel": {
    "currentState": "主線延續偏多",
    "confidence": 82,
    "takeaway": "2026/05/27 到 2026/05/25 三支影片交叉後，立隆、超豐、同欣電、佳必琪、矽格、良維、安勤、奇鋐、貿聯、台燿、勤誠 是目前最穩的 3 日共通輪漲股；盟立、直得續、尖點、聯亞、景碩 則偏向高檔辨識。",
    "transitions": [
      {
        "label": "維持主線延續",
        "value": "82%"
    ...
    "drivers": [
      "2026/05/27 輪漲股是 立隆、超豐、同欣電、佳必琪、矽格、良維、安勤、健鼎",
      "2026/05/26 對照下，可直接交叉出 立隆、超豐、同欣電、佳必琪、矽格、良維、安勤、健鼎、奇鋐、貿聯、台燿、勤誠",
      "2026/05/25 對照下，可直接交叉出 立隆、超豐、同欣電、佳必琪、矽格、良維、安勤、奇鋐、貿聯、台燿、勤誠"
    ]
  },
  "monteCarloScenarios": [
    {
      ...
      "name": "勤誠",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 605 - 1087",
      "stopLoss": "3% 停損命中率 86%",
      "takeProfit": "8% 停利命中率 64%",
      "drawdown": "模擬最大回撤中位數 30.0%",
    ...
    },
    {
      ...
      "name": "奇鋐",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 1132 - 2309",
      "stopLoss": "3% 停損命中率 84%",
      "takeProfit": "8% 停利命中率 68%",
      "drawdown": "模擬最大回撤中位數 31.6%",
    ...
    },
    {
      ...
      "name": "立隆",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 66 - 176",
      "stopLoss": "3% 停損命中率 88%",
      "takeProfit": "8% 停利命中率 74%",
      "drawdown": "模擬最大回撤中位數 47.2%",
      "note": "立隆 屬於可以當第二層風險觀察的延續股。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
