const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.31.2200",
    "lastUpdated": "2026/05/31 22:00",
    "lastAutomationSync": "2026/05/31 22:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.53%、東京威力科創 +0.19%、Advantest -0.65%。日股科技股續強，通常代表亞洲電子鏈對 其他、封測、線纜補漲 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.53%",
            "TEL +0.19%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +3.55%、Samsung +5.84%、SK Hynix +1.92%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +3.55%",
            "Samsung +5.84%",
            "Hynix +1.92%"
    ...
    },
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.53%、東京威力科創 +0.19%、Advantest -0.65%。日股科技股續強，通常代表亞洲電子鏈對 其他、被動元件、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.53%",
            "TEL +0.19%",
            "日股偏多"
    ...
    },
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.53%、東京威力科創 +0.19%、Advantest -0.65%。日股科技股續強，通常代表亞洲電子鏈對 封測、其他、被動元件 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.53%",
            "TEL +0.19%",
            "日股偏多"
  ...
  "stocks": [
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "超豐 在 2026/05/29、2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.859、40 日 %B 約 0.935；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/05/29、2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.960、40 日 %B 約 0.648；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "PCB",
      "note": "健鼎 在 2026/05/29、2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.658、40 日 %B 約 0.523；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 散熱 / 伺服器",
      "note": "奇鋐 在 2026/05/29、2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.462、40 日 %B 約 0.378；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/05/29、2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.459、40 日 %B 約 0.415；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 伺服器 / 顯卡",
      "note": "技嘉 在 2026/05/29、2026/05/28 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.403、40 日 %B 約 0.317；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "立隆 在 2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.736、40 日 %B 約 0.523；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "網通 / 交換器",
      "note": "智邦 在 2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.466、40 日 %B 約 0.378；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
  ...
  "monteCarloScenarios": [
    {
      ...
      "name": "健鼎",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 337 - 467",
      "stopLoss": "3% 停損命中率 74%",
      "takeProfit": "8% 停利命中率 62%",
      "drawdown": "模擬最大回撤中位數 15.7%",
    ...
    },
    {
      ...
      "name": "勤誠",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 633 - 1053",
      "stopLoss": "3% 停損命中率 87%",
      "takeProfit": "8% 停利命中率 62%",
      "drawdown": "模擬最大回撤中位數 28.8%",
