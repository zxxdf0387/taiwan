const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.26.2200",
    "lastUpdated": "2026/05/26 22:00",
    "lastAutomationSync": "2026/05/26 22:00",
    "videoBasis": "2026/05/26、2026/05/25、2026/05/22"
  },
  "marketMood": {
    "label": "主線延續偏多",
    "summary": "2026/05/26 到 2026/05/22 三支影片交叉後，富鼎、超豐、同欣電、光寶、佳必琪、矽格、良維、安勤、力成、奇鋐、貿聯、勤誠 是目前最穩的 3 日共通輪漲股；盟立、尖點、聯亞、景碩、穩懋 則偏向高檔辨識。",
    "score": 82,
    "openingPlan": "先看 立隆、富鼎、超豐 是否續強"
  },
  "headlines": [
    {
      "tone": "positive",
      "title": "最新影片：2026/05/26",
      "summary": "2026/05/26 這支影片把 立隆、富鼎、超豐、同欣電、光寶、佳必琪、矽格、良維、安勤、台半、健鼎、力成、奇鋐、貿聯、台燿、勤誠列輪漲，盟立、直得續、尖點、聯亞、景碩、穩懋列高出，聯電、華邦、頎邦列當沖。",
      "meta": "16 檔輪漲 ｜ 6 檔高出 ｜ 3 檔當沖",
      "analysis": "主軸偏向 封測、其他、被動元件。 和其他影片重複輪漲最多的是 立隆、富鼎、超豐、同欣電、光寶。 高出辨識股集中在 盟立、尖點、聯亞、景碩。 當沖股則是 聯電、頎邦，節奏偏快。",
      "tags": [
        "主軸 封測",
        "15 檔重複輪漲",
        "5 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +1.15%、S&P 500 +0.73%、費半 +5.05%。美股科技鏈偏多，對 封測、其他、被動元件 這組主軸有順風。",
          "signals": [
            "Nasdaq +1.15%",
            "費半 +5.05%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.25%、東京威力科創 -1.46%、Advantest -6.05%。日股科技股轉弱，通常代表亞洲電子鏈對 封測、其他、被動元件 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.25%",
            "TEL -1.46%",
            "日股轉弱"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +2.55%、Samsung +2.22%、SK Hynix +5.72%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +2.55%",
            "Samsung +2.22%",
            "Hynix +5.72%"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 封測、其他、被動元件 輪動，蓋牌比較像 國巨、緯創、日電貿。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "國巨：曾在 2026/05/25 列輪漲 / 曾在 2026/05/22 列輪漲",
    ...
    },
    {
      ...
      "marketLinks": {
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 封測、其他、被動元件 輪動，蓋牌比較像 健鼎、日電貿、台半。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "健鼎：曾在 2026/05/26 列輪漲 / 曾在 2026/05/22 列輪漲",
            "日電貿：同屬 被動元件 / 同族群 被動元件",
            "台半：曾在 2026/05/26 列輪漲"
          ]
        }
      }
    },
    {
      ...
      "analysis": "主軸偏向 封測、其他、感測。 和其他影片重複輪漲最多的是 同欣電、超豐、安勤、佳必琪、富鼎。 高出辨識股集中在 盟立、尖點、聯亞、景碩。 當沖股則是 聯電、群創、頎邦，節奏偏快。",
      "tags": [
        "主軸 封測",
        "15 檔重複輪漲",
        "5 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +1.15%、S&P 500 +0.73%、費半 +5.05%。美股科技鏈偏多，對 封測、其他、感測 這組主軸有順風。",
          "signals": [
            "Nasdaq +1.15%",
            "費半 +5.05%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.25%、東京威力科創 -1.46%、Advantest -6.05%。日股科技股轉弱，通常代表亞洲電子鏈對 封測、其他、感測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.25%",
            "TEL -1.46%",
            "日股轉弱"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 封測、其他、感測 輪動，蓋牌比較像 台燿、立隆、台半。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "台燿：曾在 2026/05/26 列輪漲 / 曾在 2026/05/25 列輪漲",
            "立隆：曾在 2026/05/26 列輪漲 / 曾在 2026/05/25 列輪漲",
            "台半：曾在 2026/05/26 列輪漲"
          ]
        }
      }
  ...
  "stocks": [
    {
      ...
      "name": "立隆",
      "bias": "2日共通",
      "gap": "2026/05/26、2026/05/25",
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "立隆 在 2026/05/26、2026/05/25 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.736、40 日 %B 約 0.523；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "富鼎",
      "bias": "3日共通",
      "gap": "2026/05/26、2026/05/25、2026/05/22",
      "foreign": "交叉輪漲",
      "volume": "MOSFET",
      "note": "富鼎 在 2026/05/26、2026/05/25、2026/05/22 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.581、40 日 %B 約 0.401；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "超豐 在 2026/05/26、2026/05/25、2026/05/22 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.859、40 日 %B 約 0.935；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "感測 / 封測",
      "note": "同欣電 在 2026/05/26、2026/05/25、2026/05/22 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.952、40 日 %B 約 0.890；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "電源 / 電子權值",
      "note": "光寶 在 2026/05/26、2026/05/25、2026/05/22 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.616、40 日 %B 約 0.678；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "佳必琪 在 2026/05/26、2026/05/25、2026/05/22 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/05/26、2026/05/25、2026/05/22 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.960、40 日 %B 約 0.648；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "線材 / AI 電源",
      "note": "良維 在 2026/05/26、2026/05/25、2026/05/22 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "安勤 在 2026/05/26、2026/05/25、2026/05/22 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "健鼎",
      "bias": "2日共通",
      "gap": "2026/05/26、2026/05/22",
      "foreign": "交叉輪漲",
      "volume": "PCB",
      "note": "健鼎 在 2026/05/26、2026/05/22 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.658、40 日 %B 約 0.523；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "力成 在 2026/05/26、2026/05/25、2026/05/22 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.784、40 日 %B 約 0.925；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 散熱 / 伺服器",
      "note": "奇鋐 在 2026/05/26、2026/05/25、2026/05/22 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.462、40 日 %B 約 0.378；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/05/26、2026/05/25、2026/05/22 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.385、40 日 %B 約 0.314；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "CCL / PCB",
      "note": "台燿 在 2026/05/26、2026/05/25 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
  ...
  "checklist": [
    "先看 2026/05/26 與前兩支影片的交叉輪漲股：富鼎、超豐、同欣電、光寶、佳必琪、矽格、良維、安勤、力成、奇鋐、貿聯、勤誠。",
    "高出股 盟立、尖點、聯亞、景碩、穩懋 要和輪漲股分開，不要混成主攻名單。",
    "當沖股 聯電、頎邦 屬快節奏，不適合直接列成首選。",
    "今天盤前先看 光寶、富鼎、勤誠 是否續量。"
  ],
  "risks": [
    {
      "level": "high",
      "title": "影片基準已更新到 2026/05/26、2026/05/25、2026/05/22",
      "detail": "目前基準改用黃清照 YouTube 頻道 /videos 頁面排序，最新三支就是 2026/05/26、2026/05/25、2026/05/22。"
    },
    {
      "level": "medium",
      "title": "有出現三日共通輪漲股",
      "detail": "富鼎、超豐、同欣電、光寶、佳必琪、矽格、良維、安勤、力成、奇鋐、貿聯、勤誠 是目前最穩的 3 日共通輪漲股。"
    },
    {
      "level": "medium",
      "title": "高出股與當沖股要拆開處理",
      "detail": "盟立、尖點、聯亞、景碩、穩懋 偏高檔辨識；聯電、頎邦 偏快節奏，和輪漲股不是同一層級。"
    }
  ],
  "bollingerRankings": [
    {
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/05/26 收盤",
      "summary": "富鼎 用 TWSE 官方日資料重算後，20 日 %B 約 0.581、40 日 %B 約 0.401；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.581",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/05/26 收盤",
      "summary": "力成 用 TWSE 官方日資料重算後，20 日 %B 約 0.784、40 日 %B 約 0.925；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.784",
        "40日不過熱"
  ...
  "markovModel": {
    "currentState": "主線延續偏多",
    "confidence": 82,
    "takeaway": "2026/05/26 到 2026/05/22 三支影片交叉後，富鼎、超豐、同欣電、光寶、佳必琪、矽格、良維、安勤、力成、奇鋐、貿聯、勤誠 是目前最穩的 3 日共通輪漲股；盟立、尖點、聯亞、景碩、穩懋 則偏向高檔辨識。",
    "transitions": [
      {
        "label": "維持主線延續",
        "value": "82%"
    ...
    "drivers": [
      "2026/05/26 輪漲股是 立隆、富鼎、超豐、同欣電、光寶、佳必琪、矽格、良維",
      "2026/05/25 對照下，可直接交叉出 立隆、富鼎、超豐、同欣電、光寶、佳必琪、矽格、良維、安勤、力成、奇鋐、貿聯、台燿、勤誠",
      "2026/05/22 對照下，可直接交叉出 富鼎、超豐、同欣電、光寶、佳必琪、矽格、良維、安勤、健鼎、力成、奇鋐、貿聯、勤誠"
    ]
  },
  "monteCarloScenarios": [
    {
      ...
      "name": "光寶",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 158 - 213",
      "stopLoss": "3% 停損命中率 70%",
      "takeProfit": "8% 停利命中率 68%",
      "drawdown": "模擬最大回撤中位數 14.1%",
    ...
    },
    {
      ...
      "name": "勤誠",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 607 - 1167",
      "stopLoss": "3% 停損命中率 86%",
      "takeProfit": "8% 停利命中率 65%",
      "drawdown": "模擬最大回撤中位數 29.9%",
