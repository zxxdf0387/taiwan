const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.03.0902",
    "lastUpdated": "2026/06/03 09:00",
    "lastAutomationSync": "2026/06/03 09:00",
    "videoBasis": "2026/06/02、2026/06/01、2026/05/29"
  },
  "marketMood": {
    "label": "主線延續偏多",
    "summary": "2026/06/02 到 2026/05/29 三支影片交叉後，佳必琪、神達、騰輝、貿聯、鴻海、台燿、勤誠、信邦、良維 是目前最穩的 3 日共通輪漲股；盟立、聯亞、聯鈞、金居 則偏向高檔辨識。",
    "score": 82,
    "openingPlan": "先看 緯創、佳必琪、神達 是否續強"
  },
  "headlines": [
    {
      "tone": "positive",
      "title": "最新影片：2026/06/02",
      "summary": "2026/06/02 這支影片把 緯創、佳必琪、神達、騰輝、光寶、超豐、東陽、尼克森、雙鴻、貿聯、鴻海、台燿、勤誠、信邦、南亞科、良維列輪漲，盟立、友達、英業達、聯亞、聯鈞、金居、穩懋列高出，華邦、聯電列當沖。",
      "meta": "16 檔輪漲 ｜ 7 檔高出 ｜ 2 檔當沖",
      "analysis": "主軸偏向 其他、AI PC、伺服器。 和其他影片重複輪漲最多的是 緯創、佳必琪、神達、騰輝、光寶。 高出辨識股集中在 盟立、聯亞、聯鈞、金居。 當沖股則是 華邦、聯電，節奏偏快。",
      "tags": [
        "主軸 其他",
        "13 檔重複輪漲",
        "4 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.03%、S&P 500 +0.13%、費半 +5.79%。美股科技鏈偏多，對 其他、AI PC、伺服器 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.03%",
            "費半 +5.79%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +1.61%、東京威力科創 +9.22%、Advantest +4.41%。日股科技股續強，通常代表亞洲電子鏈對 其他、AI PC、伺服器 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +1.61%",
            "TEL +9.22%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +3.68%、Samsung +3.30%、SK Hynix -0.13%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +3.68%",
            "Samsung +3.30%",
            "Hynix -0.13%"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、AI PC、伺服器 輪動，蓋牌比較像 技嘉、奇鋐、矽格。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "技嘉：曾在 2026/06/01 列輪漲 / 曾在 2026/05/29 列輪漲",
            "奇鋐：曾在 2026/06/01 列輪漲 / 曾在 2026/05/29 列輪漲",
            "矽格：曾在 2026/06/01 列輪漲 / 曾在 2026/05/29 列輪漲"
          ]
        }
      }
    },
    {
      "tone": "neutral",
      "title": "前一支影片：2026/06/01",
      "summary": "2026/06/01 這支影片把 緯創、光寶、佳必琪、神達、騰輝、矽格、奇鋐、台燿、勤誠、貿聯、鴻海、信邦、技嘉、南亞科、良維列輪漲，盟立、群創、南電、聯亞、聯鈞、金居、穩懋續列高出，華邦、強茂、聯電列當沖。",
      "meta": "15 檔輪漲 ｜ 7 檔高出 ｜ 3 檔當沖",
      "analysis": "主軸偏向 其他、AI PC、電源。 和其他影片重複輪漲最多的是 緯創、光寶、佳必琪、神達、騰輝。 高出辨識股集中在 盟立、南電、聯亞、聯鈞。 當沖股則是 華邦、強茂、聯電，節奏偏快。",
      "tags": [
        "主軸 其他",
        "15 檔重複輪漲",
        "5 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.03%、S&P 500 +0.13%、費半 +5.79%。美股科技鏈偏多，對 其他、AI PC、電源 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.03%",
            "費半 +5.79%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +1.61%、東京威力科創 +9.22%、Advantest +4.41%。日股科技股續強，通常代表亞洲電子鏈對 其他、AI PC、電源 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +1.61%",
            "TEL +9.22%",
            "日股偏多"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、AI PC、電源 輪動，蓋牌比較像 超豐、尼克森、東洋。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "超豐：曾在 2026/06/02 列輪漲 / 曾在 2026/05/29 列輪漲",
            "尼克森：曾在 2026/06/02 列輪漲",
            "東洋：曾在 2026/05/29 列輪漲"
          ]
        }
      }
    },
    {
      "tone": "neutral",
      "title": "再前一支影片：2026/05/29",
      "summary": "2026/05/29 這支影片把 萬泰科、佳必琪、良維、騰輝、超豐、神達、矽格、東洋、耿鼎、健鼎、奇鋐、貿聯、台燿、勤誠、鴻海、信邦、技嘉列輪漲，南電、聯亞、聯鈞列高出，華邦、頎邦、台半、強茂、聯電列當沖。",
      "meta": "17 檔輪漲 ｜ 3 檔高出 ｜ 5 檔當沖",
      "analysis": "主軸偏向 其他、封測、線纜補漲。 和其他影片重複輪漲最多的是 佳必琪、良維、騰輝、超豐、神達。 高出辨識股集中在 南電、聯亞、聯鈞。 當沖股則是 華邦、強茂、聯電，節奏偏快。",
      "tags": [
        "主軸 其他",
        "13 檔重複輪漲",
        "3 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.03%、S&P 500 +0.13%、費半 +5.79%。美股科技鏈偏多，對 其他、封測、線纜補漲 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.03%",
            "費半 +5.79%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +1.61%、東京威力科創 +9.22%、Advantest +4.41%。日股科技股續強，通常代表亞洲電子鏈對 其他、封測、線纜補漲 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +1.61%",
            "TEL +9.22%",
            "日股偏多"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、封測、線纜補漲 輪動，蓋牌比較像 光寶、南亞科、緯創。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "光寶：曾在 2026/06/02 列輪漲 / 曾在 2026/06/01 列輪漲",
            "南亞科：曾在 2026/06/02 列輪漲 / 曾在 2026/06/01 列輪漲",
            "緯創：曾在 2026/06/02 列輪漲 / 曾在 2026/06/01 列輪漲"
          ]
        }
      }
    }
  ...
  "stocks": [
    {
      ...
      "name": "緯創",
      "bias": "2日共通",
      "gap": "2026/06/02、2026/06/01",
      "foreign": "交叉輪漲",
      "volume": "AI PC / 伺服器",
      "note": "緯創 在 2026/06/02、2026/06/01 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.545、40 日 %B 約 0.423；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "佳必琪",
      "bias": "3日共通",
      "gap": "2026/06/02、2026/06/01、2026/05/29",
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "佳必琪 在 2026/06/02、2026/06/01、2026/05/29 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "伺服器 / 車電",
      "note": "神達 在 2026/06/02、2026/06/01、2026/05/29 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.139、40 日 %B 約 -0.169；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "騰輝 在 2026/06/02、2026/06/01、2026/05/29 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "電源 / 電子權值",
      "note": "光寶 在 2026/06/02、2026/06/01 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.112、40 日 %B 約 -0.122；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "超豐",
      "bias": "2日共通",
      "gap": "2026/06/02、2026/05/29",
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "超豐 在 2026/06/02、2026/05/29 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.286、40 日 %B 約 0.196；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/06/02、2026/06/01、2026/05/29 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.845、40 日 %B 約 0.806；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "電子權值 / AI 伺服器",
      "note": "鴻海 在 2026/06/02、2026/06/01、2026/05/29 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.001、40 日 %B 約 0.003；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "CCL / PCB",
      "note": "台燿 在 2026/06/02、2026/06/01、2026/05/29 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/06/02、2026/06/01、2026/05/29 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.131、40 日 %B 約 0.280；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "連接線組",
      "note": "信邦 在 2026/06/02、2026/06/01、2026/05/29 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.605、40 日 %B 約 0.398；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "DRAM",
      "note": "南亞科 在 2026/06/02、2026/06/01 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.032、40 日 %B 約 0.131；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "線材 / AI 電源",
      "note": "良維 在 2026/06/02、2026/06/01、2026/05/29 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "矽格",
      "bias": "2日共通",
      "gap": "2026/06/01、2026/05/29",
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/06/01、2026/05/29 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.993、40 日 %B 約 0.455；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
  ...
  "checklist": [
    "先看 2026/06/02 與前兩支影片的交叉輪漲股：佳必琪、神達、騰輝、貿聯、鴻海、台燿、勤誠、信邦、良維。",
    "高出股 盟立、聯亞、聯鈞、金居 要和輪漲股分開，不要混成主攻名單。",
    "當沖股 華邦、聯電 屬快節奏，不適合直接列成首選。",
    "今天盤前先看 信邦、貿聯、緯創 是否續量。"
  ],
  "risks": [
    {
      "level": "high",
      "title": "影片基準已更新到 2026/06/02、2026/06/01、2026/05/29",
      "detail": "目前基準改用黃清照 YouTube 頻道 /videos 頁面排序，最新三支就是 2026/06/02、2026/06/01、2026/05/29。"
    },
    {
      "level": "medium",
      "title": "有出現三日共通輪漲股",
      "detail": "佳必琪、神達、騰輝、貿聯、鴻海、台燿、勤誠、信邦、良維 是目前最穩的 3 日共通輪漲股。"
    },
    {
      "level": "medium",
      "title": "高出股與當沖股要拆開處理",
      "detail": "盟立、聯亞、聯鈞、金居 偏高檔辨識；華邦、聯電 偏快節奏，和輪漲股不是同一層級。"
    }
  ],
  "bollingerRankings": [
    {
      ...
      "name": "信邦",
      "verdict": "今日首選",
      "asOf": "截至 2026/06/02 收盤",
      "summary": "信邦 用 TWSE 官方日資料重算後，20 日 %B 約 0.605、40 日 %B 約 0.398；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.605",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/06/02 收盤",
      "summary": "貿聯 用 TWSE 官方日資料重算後，20 日 %B 約 0.845、40 日 %B 約 0.806；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.845",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/06/02 收盤",
      "summary": "緯創 用 TWSE 官方日資料重算後，20 日 %B 約 0.545、40 日 %B 約 0.423；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "2日共通",
        "20日 %B 0.545",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/06/02 收盤",
      "summary": "勤誠 用 TWSE 官方日資料重算後，20 日 %B 約 0.131、40 日 %B 約 0.280；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.131",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/06/02 收盤",
      "summary": "奇鋐 用 TWSE 官方日資料重算後，20 日 %B 約 0.590、40 日 %B 約 0.366；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "2日共通",
        "20日 %B 0.590",
        "40日不過熱"
  ...
  "markovModel": {
    "currentState": "主線延續偏多",
    "confidence": 82,
    "takeaway": "2026/06/02 到 2026/05/29 三支影片交叉後，佳必琪、神達、騰輝、貿聯、鴻海、台燿、勤誠、信邦、良維 是目前最穩的 3 日共通輪漲股；盟立、聯亞、聯鈞、金居 則偏向高檔辨識。",
    "transitions": [
      {
        "label": "維持主線延續",
        "value": "82%"
    ...
    "drivers": [
      "2026/06/02 輪漲股是 緯創、佳必琪、神達、騰輝、光寶、超豐、東陽、尼克森",
      "2026/06/01 對照下，可直接交叉出 緯創、佳必琪、神達、騰輝、光寶、貿聯、鴻海、台燿、勤誠、信邦、南亞科、良維",
      "2026/05/29 對照下，可直接交叉出 佳必琪、神達、騰輝、超豐、貿聯、鴻海、台燿、勤誠、信邦、良維"
    ]
  },
  "monteCarloScenarios": [
    {
      ...
      "name": "信邦",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 200 - 284",
      "stopLoss": "3% 停損命中率 83%",
      "takeProfit": "8% 停利命中率 50%",
      "drawdown": "模擬最大回撤中位數 19.2%",
      "note": "信邦 是這版布林與重複輪漲交集最漂亮的一檔。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "貿聯",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 2655 - 3939",
      "stopLoss": "3% 停損命中率 72%",
      "takeProfit": "8% 停利命中率 83%",
      "drawdown": "模擬最大回撤中位數 18.6%",
      "note": "貿聯 屬於可以當第二層風險觀察的延續股。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "緯創",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 116 - 164",
      "stopLoss": "3% 停損命中率 75%",
      "takeProfit": "8% 停利命中率 59%",
      "drawdown": "模擬最大回撤中位數 16.1%",
      "note": "緯創 屬於可以當第二層風險觀察的延續股。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
...
const listedCodes = new Set([
  "2301", "2303", "2313", "2317", "2327", "2344", "2345", "2376",
  "2382", "2408", "2441", "2472", "3008", "3017", "3044", "3090",
  "3481", "3665", "6257", "6271", "6285", "8046", "8210", "8261",
]);
