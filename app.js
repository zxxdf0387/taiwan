const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.05.2200",
    "lastUpdated": "2026/06/05 22:00",
    "lastAutomationSync": "2026/06/05 22:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -1.87%、S&P 500 -1.11%、費半 -6.24%。美股科技鏈轉保守，對 其他、電源、封測 這組主軸會增加開高走低風險。",
          "signals": [
            "Nasdaq -1.87%",
            "費半 -6.24%",
            "電子偏保守"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -1.87%、S&P 500 -1.11%、費半 -6.24%。美股科技鏈轉保守，對 其他、封測、電源 這組主軸會增加開高走低風險。",
          "signals": [
            "Nasdaq -1.87%",
            "費半 -6.24%",
            "電子偏保守"
  ...
  "stocks": [
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 散熱 / 伺服器",
      "note": "奇鋐 在 2026/06/04、2026/06/03 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.590、40 日 %B 約 0.348；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
  ...
  "monteCarloScenarios": [
    ...
    },
    {
      ...
      "name": "智邦",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 904 - 1721",
      "stopLoss": "3% 停損命中率 89%",
      "takeProfit": "8% 停利命中率 61%",
      "drawdown": "模擬最大回撤中位數 37.0%",
