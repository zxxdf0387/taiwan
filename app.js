const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.12.2200",
    "lastUpdated": "2026/06/12 22:00",
    "lastAutomationSync": "2026/06/12 22:00",
    "videoBasis": "2026/06/12、2026/06/11、2026/06/10"
  },
  "marketMood": {
    "label": "主線延續偏多",
    "summary": "2026/06/12 到 2026/06/10 三支影片交叉後，佳必琪、騰輝、良維、東鹼 是目前最穩的 3 日共通輪漲股；高出股沒有連續重複 則偏向高檔辨識。",
    "score": 82,
    "openingPlan": "先看 佳必琪、騰輝、良維 是否續強"
  },
  "headlines": [
    {
      "tone": "positive",
      "title": "最新影片：2026/06/12",
      "summary": "2026/06/12 這支影片把 矽格、欣銓、佳必琪、騰輝、良維、聯陽、興勤、光寶、同欣電、東鹼、富鼎列輪漲，尖點、景碩列高出，華邦、聯電、日電貿、南亞科、欣興列當沖。",
      "meta": "11 檔輪漲 ｜ 2 檔高出 ｜ 5 檔當沖",
      "analysis": "主軸偏向 其他、封測、線材。 和其他影片重複輪漲最多的是 矽格、佳必琪、騰輝、良維、興勤。 當沖股則是 華邦、聯電、日電貿、南亞科，節奏偏快。",
      "tags": [
        "主軸 其他",
        "7 檔重複輪漲",
        "5 檔重複當沖"
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.57%、S&P 500 -0.20%、費半 +0.09%。美股科技鏈中性，對 其他、封測、線材 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq -0.57%",
            "費半 +0.09%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.81%、東京威力科創 +7.26%、Advantest +8.54%。日股科技股續強，通常代表亞洲電子鏈對 其他、封測、線材 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.81%",
            "TEL +7.26%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +4.63%、Samsung +7.86%、SK Hynix +2.33%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +4.63%",
            "Samsung +7.86%",
            "Hynix +2.33%"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、封測、線材 輪動，蓋牌比較像 大立光、台燿、安勤。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "大立光：曾在 2026/06/11 列輪漲 / 曾在 2026/06/10 列輪漲",
            "台燿：曾在 2026/06/11 列輪漲 / 曾在 2026/06/10 列輪漲",
    ...
    },
    {
      ...
      "analysis": "主軸偏向 其他、PCB、工業電腦。 和其他影片重複輪漲最多的是 東鹼、騰輝、佳必琪、安勤、良維。 當沖股則是 華邦、聯電、日電貿、南亞科，節奏偏快。",
      "tags": [
        "主軸 其他",
        "13 檔重複輪漲",
        "5 檔重複當沖"
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.57%、S&P 500 -0.20%、費半 +0.09%。美股科技鏈中性，對 其他、PCB、工業電腦 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq -0.57%",
            "費半 +0.09%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.81%、東京威力科創 +7.26%、Advantest +8.54%。日股科技股續強，通常代表亞洲電子鏈對 其他、PCB、工業電腦 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.81%",
            "TEL +7.26%",
            "日股偏多"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、PCB、工業電腦 輪動，蓋牌比較像 矽格、金像電、南電。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "矽格：曾在 2026/06/12 列輪漲 / 曾在 2026/06/10 列輪漲",
            "金像電：曾在 2026/06/10 列輪漲 / 同屬 PCB",
            "南電：曾在 2026/06/10 列高出 / 同屬 PCB"
          ]
        }
      }
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.57%、S&P 500 -0.20%、費半 +0.09%。美股科技鏈中性，對 其他、被動元件、PCB 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq -0.57%",
            "費半 +0.09%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.81%、東京威力科創 +7.26%、Advantest +8.54%。日股科技股續強，通常代表亞洲電子鏈對 其他、被動元件、PCB 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.81%",
            "TEL +7.26%",
            "日股偏多"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、被動元件、PCB 輪動，蓋牌比較像 光寶、敬鵬、興勤。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "光寶：曾在 2026/06/12 列輪漲 / 曾在 2026/06/11 列輪漲",
            "敬鵬：曾在 2026/06/11 列輪漲 / 同屬 PCB",
            "興勤：曾在 2026/06/12 列輪漲 / 曾在 2026/06/11 列輪漲"
          ]
        }
      }
    }
  ...
  "stocks": [
    {
      ...
      "name": "矽格",
      "bias": "2日共通",
      "gap": "2026/06/12、2026/06/10",
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/06/12、2026/06/10 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.993、40 日 %B 約 0.455；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "佳必琪",
      "bias": "3日共通",
      "gap": "2026/06/12、2026/06/11、2026/06/10",
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "佳必琪 在 2026/06/12、2026/06/11、2026/06/10 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "騰輝 在 2026/06/12、2026/06/11、2026/06/10 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "線材 / AI 電源",
      "note": "良維 在 2026/06/12、2026/06/11、2026/06/10 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "興勤",
      "bias": "2日共通",
      "gap": "2026/06/12、2026/06/11",
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "興勤 在 2026/06/12、2026/06/11 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "電源 / 電子權值",
      "note": "光寶 在 2026/06/12、2026/06/11 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.112、40 日 %B 約 -0.122；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "東鹼 在 2026/06/12、2026/06/11、2026/06/10 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "東陽 在 2026/06/11、2026/06/10 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/06/11、2026/06/10 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.131、40 日 %B 約 0.280；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "PCB",
      "note": "健鼎 在 2026/06/11、2026/06/10 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.010、40 日 %B 約 0.195；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "國巨 在 2026/06/11、2026/06/10 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.061、40 日 %B 約 0.127；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "CCL / PCB",
      "note": "台燿 在 2026/06/11、2026/06/10 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
  ...
  "checklist": [
    "先看 2026/06/12 與前兩支影片的交叉輪漲股：佳必琪、騰輝、良維、東鹼。",
    "若高出股沒有重複，就優先看輪漲股延續。",
    "當沖股 華邦、聯電、日電貿、南亞科、欣興 屬快節奏，不適合直接列成首選。",
    "今天盤前先看 矽格、奇鋐、智邦 是否續量。"
  ],
  "risks": [
    {
      "level": "high",
      "title": "影片基準已更新到 2026/06/12、2026/06/11、2026/06/10",
      "detail": "目前基準改用黃清照 YouTube 頻道 /videos 頁面排序，最新三支就是 2026/06/12、2026/06/11、2026/06/10。"
    },
    {
      "level": "medium",
      "title": "有出現三日共通輪漲股",
      "detail": "佳必琪、騰輝、良維、東鹼 是目前最穩的 3 日共通輪漲股。"
    },
    {
      "level": "medium",
      "title": "高出股與當沖股要拆開處理",
      "detail": "高出股暫無重複 偏高檔辨識；華邦、聯電、日電貿、南亞科、欣興 偏快節奏，和輪漲股不是同一層級。"
    }
  ],
  "bollingerRankings": [
    {
    ...
    },
    {
      ...
      "verdict": "最新補強股",
      "asOf": "截至 2026/06/12 收盤",
      "summary": "金像電 用 TWSE 官方日資料重算後，20 日 %B 約 0.426、40 日 %B 約 0.295；雖然只出現在最新影片，但位階仍算乾淨。",
      "signals": [
        "最新主線",
        "20日 %B 0.426",
        "40日不過熱"
  ...
  "markovModel": {
    "currentState": "主線延續偏多",
    "confidence": 82,
    "takeaway": "2026/06/12 到 2026/06/10 三支影片交叉後，佳必琪、騰輝、良維、東鹼 是目前最穩的 3 日共通輪漲股；高出股沒有連續重複 則偏向高檔辨識。",
    "transitions": [
      {
        "label": "維持主線延續",
        "value": "82%"
    ...
    "drivers": [
      "2026/06/12 輪漲股是 矽格、欣銓、佳必琪、騰輝、良維、聯陽、興勤、光寶",
      "2026/06/11 對照下，可直接交叉出 佳必琪、騰輝、良維、興勤、光寶、東鹼",
      "2026/06/10 對照下，可直接交叉出 矽格、佳必琪、騰輝、良維、東鹼"
    ]
  },
  "monteCarloScenarios": [
    {
    ...
    },
    {
      ...
      "name": "奇鋐",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 1407 - 2456",
      "stopLoss": "3% 停損命中率 89%",
      "takeProfit": "8% 停利命中率 69%",
    ...
    },
    {
      ...
      "name": "智邦",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 927 - 1852",
      "stopLoss": "3% 停損命中率 91%",
      "takeProfit": "8% 停利命中率 67%",
      "drawdown": "模擬最大回撤中位數 34.4%",
