const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.22.2200",
    "lastUpdated": "2026/05/22 22:00",
    "lastAutomationSync": "2026/05/22 22:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.50%、S&P 500 +0.58%、費半 +2.16%。美股科技鏈偏多，對 封測、其他、感測 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.50%",
            "費半 +2.16%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.68%、東京威力科創 +2.11%、Advantest +0.37%。日股科技股續強，通常代表亞洲電子鏈對 封測、其他、感測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.68%",
            "TEL +2.11%",
            "日股偏多"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.50%、S&P 500 +0.58%、費半 +2.16%。美股科技鏈偏多，對 被動元件、封測、感測 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.50%",
            "費半 +2.16%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.68%、東京威力科創 +2.11%、Advantest +0.37%。日股科技股續強，通常代表亞洲電子鏈對 被動元件、封測、感測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.68%",
            "TEL +2.11%",
            "日股偏多"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.50%、S&P 500 +0.58%、費半 +2.16%。美股科技鏈偏多，對 被動元件、其他、封測 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.50%",
            "費半 +2.16%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.68%、東京威力科創 +2.11%、Advantest +0.37%。日股科技股續強，通常代表亞洲電子鏈對 被動元件、其他、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.68%",
            "TEL +2.11%",
            "日股偏多"
  ...
  "stocks": [
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "立隆 在 2026/05/21、2026/05/20 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.736、40 日 %B 約 0.523；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
  ...
  "monteCarloScenarios": [
    ...
    },
    {
      ...
      "name": "健鼎",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 301 - 436",
      "stopLoss": "3% 停損命中率 88%",
      "takeProfit": "8% 停利命中率 60%",
      "drawdown": "模擬最大回撤中位數 23.3%",
    ...
    },
    {
      ...
      "name": "勤誠",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 586 - 1019",
      "stopLoss": "3% 停損命中率 91%",
      "takeProfit": "8% 停利命中率 54%",
      "drawdown": "模擬最大回撤中位數 30.8%",
