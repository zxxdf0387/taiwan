const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.30.0900",
    "lastUpdated": "2026/05/30 09:00",
    "lastAutomationSync": "2026/05/30 09:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.47%、東京威力科創 +0.19%、Advantest -0.65%。日股科技股震盪，通常代表亞洲電子鏈對 其他、封測、線纜補漲 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.47%",
            "TEL +0.19%",
            "日股中性"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI -0.53%、Samsung +5.84%、SK Hynix +1.92%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI -0.53%",
            "Samsung +5.84%",
            "Hynix +1.92%"
    ...
    },
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.47%、東京威力科創 +0.19%、Advantest -0.65%。日股科技股震盪，通常代表亞洲電子鏈對 其他、被動元件、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.47%",
            "TEL +0.19%",
            "日股中性"
    ...
    },
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.47%、東京威力科創 +0.19%、Advantest -0.65%。日股科技股震盪，通常代表亞洲電子鏈對 封測、其他、被動元件 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.47%",
            "TEL +0.19%",
            "日股中性"
  ...
  "stocks": [
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "超豐 在 2026/05/29、2026/05/28、2026/05/27 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/05/29、2026/05/28、2026/05/27 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "PCB",
      "note": "健鼎 在 2026/05/29、2026/05/28、2026/05/27 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 散熱 / 伺服器",
      "note": "奇鋐 在 2026/05/29、2026/05/28、2026/05/27 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/05/29、2026/05/28、2026/05/27 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/05/29、2026/05/28、2026/05/27 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 伺服器 / 顯卡",
      "note": "技嘉 在 2026/05/29、2026/05/28 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "被動元件",
      "note": "立隆 在 2026/05/28、2026/05/27 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "網通 / 交換器",
      "note": "智邦 在 2026/05/28、2026/05/27 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
