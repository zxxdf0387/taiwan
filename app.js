const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.03.2220",
    "lastUpdated": "2026/06/03 22:00",
    "lastAutomationSync": "2026/06/03 22:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.68%、S&P 500 -0.46%、費半 -0.13%。美股科技鏈中性，對 其他、封測、電源 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq -0.68%",
            "費半 -0.13%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.50%、東京威力科創 +13.39%、Advantest +5.09%。日股科技股續強，通常代表亞洲電子鏈對 其他、封測、電源 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.50%",
            "TEL +13.39%",
            "日股偏多"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.68%、S&P 500 -0.46%、費半 -0.13%。美股科技鏈中性，對 其他、AI PC、伺服器 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq -0.68%",
            "費半 -0.13%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.50%、東京威力科創 +13.39%、Advantest +5.09%。日股科技股續強，通常代表亞洲電子鏈對 其他、AI PC、伺服器 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.50%",
            "TEL +13.39%",
            "日股偏多"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.68%、S&P 500 -0.46%、費半 -0.13%。美股科技鏈中性，對 其他、AI PC、電源 這組主軸仍要看台股自己量能。",
          "signals": [
            "Nasdaq -0.68%",
            "費半 -0.13%",
            "電子中性"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +2.50%、東京威力科創 +13.39%、Advantest +5.09%。日股科技股續強，通常代表亞洲電子鏈對 其他、AI PC、電源 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +2.50%",
            "TEL +13.39%",
            "日股偏多"
  ...
  "stocks": [
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI PC / 伺服器",
      "note": "緯創 在 2026/06/02、2026/06/01 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.000、40 日 %B 約 0.105；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "電源 / 電子權值",
      "note": "光寶 在 2026/06/03、2026/06/02、2026/06/01 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/06/03、2026/06/01 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "伺服器 / 車電",
      "note": "神達 在 2026/06/03、2026/06/02、2026/06/01 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "超豐 在 2026/06/03、2026/06/02 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/06/03、2026/06/02、2026/06/01 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/06/03、2026/06/02、2026/06/01 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.774、40 日 %B 約 0.428；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
  ...
  "bollingerRankings": [
    {
      ...
      "summary": "勤誠 用 TWSE 官方日資料重算後，20 日 %B 約 0.774、40 日 %B 約 0.428；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.774",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/06/03 收盤",
      "summary": "南亞科 用 TWSE 官方日資料重算後，20 日 %B 約 0.493、40 日 %B 約 0.273；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "2日共通",
        "20日 %B 0.493",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "最新補強股",
      "asOf": "截至 2026/06/03 收盤",
      "summary": "智邦 用 TWSE 官方日資料重算後，20 日 %B 約 0.486、40 日 %B 約 0.311；雖然只出現在最新影片，但位階仍算乾淨。",
      "signals": [
        "最新主線",
        "20日 %B 0.486",
        "40日不過熱"
  ...
  "monteCarloScenarios": [
    {
      ...
      "name": "勤誠",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 726 - 1434",
      "stopLoss": "3% 停損命中率 86%",
      "takeProfit": "8% 停利命中率 67%",
      "drawdown": "模擬最大回撤中位數 33.1%",
      "note": "勤誠 是這版布林與重複輪漲交集最漂亮的一檔。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "奇鋐",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 1386 - 2532",
      "stopLoss": "3% 停損命中率 86%",
      "takeProfit": "8% 停利命中率 72%",
    ...
    },
    {
      ...
      "name": "信邦",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 203 - 286",
      "stopLoss": "3% 停損命中率 81%",
      "takeProfit": "8% 停利命中率 59%",
      "drawdown": "模擬最大回撤中位數 19.1%",
      "note": "信邦 屬於可以當第二層風險觀察的延續股。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
