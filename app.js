const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.12.0900",
    "lastUpdated": "2026/06/12 09:00",
    "lastAutomationSync": "2026/06/12 09:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +2.54%、S&P 500 +1.75%、費半 +8.39%。美股科技鏈偏多，對 其他、PCB、工業電腦 這組主軸有順風。",
          "signals": [
            "Nasdaq +2.54%",
            "費半 +8.39%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +3.90%、東京威力科創 +8.47%、Advantest +9.45%。日股科技股續強，通常代表亞洲電子鏈對 其他、PCB、工業電腦 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +3.90%",
            "TEL +8.47%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +8.84%、Samsung +12.54%、SK Hynix +8.71%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +8.84%",
            "Samsung +12.54%",
            "Hynix +8.71%"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +2.54%、S&P 500 +1.75%、費半 +8.39%。美股科技鏈偏多，對 其他、被動元件、PCB 這組主軸有順風。",
          "signals": [
            "Nasdaq +2.54%",
            "費半 +8.39%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +3.90%、東京威力科創 +8.47%、Advantest +9.45%。日股科技股續強，通常代表亞洲電子鏈對 其他、被動元件、PCB 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +3.90%",
            "TEL +8.47%",
            "日股偏多"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +2.54%、S&P 500 +1.75%、費半 +8.39%。美股科技鏈偏多，對 其他、PCB、電池材料 這組主軸有順風。",
          "signals": [
            "Nasdaq +2.54%",
            "費半 +8.39%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +3.90%、東京威力科創 +8.47%、Advantest +9.45%。日股科技股續強，通常代表亞洲電子鏈對 其他、PCB、電池材料 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +3.90%",
            "TEL +8.47%",
            "日股偏多"
  ...
  "bollingerRankings": [
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/06/11 收盤",
      "summary": "矽格 用 TWSE 官方日資料重算後，20 日 %B 約 0.610、40 日 %B 約 0.329；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "2日共通",
        "20日 %B 0.610",
        "40日不過熱"
  ...
  "monteCarloScenarios": [
    {
      ...
      "name": "勤誠",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 595 - 996",
      "stopLoss": "3% 停損命中率 89%",
      "takeProfit": "8% 停利命中率 65%",
      "drawdown": "模擬最大回撤中位數 28.2%",
    ...
    },
    {
      ...
      "name": "國巨",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 120 - 366",
      "stopLoss": "3% 停損命中率 89%",
      "takeProfit": "8% 停利命中率 77%",
      "drawdown": "模擬最大回撤中位數 47.2%",
