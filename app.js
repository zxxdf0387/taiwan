const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.01.2200",
    "lastUpdated": "2026/06/01 22:00",
    "lastAutomationSync": "2026/06/01 22:00",
    "videoBasis": "2026/06/01、2026/05/29、2026/05/28"
  },
  "marketMood": {
    "label": "主線延續偏多",
    "summary": "2026/06/01 到 2026/05/28 三支影片交叉後，佳必琪、矽格、奇鋐、台燿、勤誠、貿聯、技嘉、良維 是目前最穩的 3 日共通輪漲股；南電、聯亞、聯鈞 則偏向高檔辨識。",
    "score": 82,
    "openingPlan": "先看 佳必琪、神達、騰輝 是否續強"
  },
  "headlines": [
    {
      "tone": "positive",
      "title": "最新影片：2026/06/01",
      ...
      "analysis": "主軸偏向 其他、AI PC、電源。 和其他影片重複輪漲最多的是 佳必琪、神達、騰輝、矽格、奇鋐。 高出辨識股集中在 南電、聯亞、聯鈞。 當沖股則是 華邦、強茂、聯電，節奏偏快。",
      "tags": [
        "主軸 其他",
        "12 檔重複輪漲",
        "3 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.16%、S&P 500 -0.10%、費半 -1.91%。美股科技鏈轉保守，對 其他、AI PC、電源 這組主軸會增加開高走低風險。",
          "signals": [
            "Nasdaq -0.16%",
            "費半 -1.91%",
            "電子偏保守"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +0.91%、東京威力科創 +1.22%、Advantest -1.89%。日股科技股震盪，通常代表亞洲電子鏈對 其他、AI PC、電源 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +0.91%",
            "TEL +1.22%",
            "日股中性"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +3.68%、Samsung +10.09%、SK Hynix +1.29%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +3.68%",
            "Samsung +10.09%",
            "Hynix +1.29%"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、AI PC、電源 輪動，蓋牌比較像 耿鼎、健鼎、超豐。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "耿鼎：曾在 2026/05/29 列輪漲 / 曾在 2026/05/28 列輪漲",
            "健鼎：曾在 2026/05/29 列輪漲 / 曾在 2026/05/28 列輪漲",
            "超豐：曾在 2026/05/29 列輪漲 / 曾在 2026/05/28 列輪漲"
          ]
        }
      }
    },
    {
      ...
      "analysis": "主軸偏向 其他、封測、線纜補漲。 和其他影片重複輪漲最多的是 佳必琪、良維、騰輝、超豐、神達。 高出辨識股集中在 南電、聯亞、聯鈞。 當沖股則是 華邦、頎邦、台半、強茂，節奏偏快。",
      "tags": [
        "主軸 其他",
        "15 檔重複輪漲",
        "3 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.16%、S&P 500 -0.10%、費半 -1.91%。美股科技鏈轉保守，對 其他、封測、線纜補漲 這組主軸會增加開高走低風險。",
          "signals": [
            "Nasdaq -0.16%",
            "費半 -1.91%",
            "電子偏保守"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +0.91%、東京威力科創 +1.22%、Advantest -1.89%。日股科技股震盪，通常代表亞洲電子鏈對 其他、封測、線纜補漲 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +0.91%",
            "TEL +1.22%",
            "日股中性"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、封測、線纜補漲 輪動，蓋牌比較像 力成、尼克森、立隆。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "力成：同屬 封測 / 同族群 封測",
            "尼克森：曾在 2026/05/28 列輪漲",
            "立隆：曾在 2026/05/28 列輪漲"
          ]
        }
      }
    },
    {
      "tone": "neutral",
      "title": "再前一支影片：2026/05/28",
      "summary": "2026/05/28 這支影片把 立隆、興勤、超豐、佳必琪、矽格、良維、安勤、尼克森、東陽、耿鼎、健鼎、奇鋐、貿聯、台燿、勤誠、智邦、技嘉列輪漲，全新、聯亞、景碩、聯鈞列高出，台半、強茂、聯電、頎邦列當沖。",
      "meta": "17 檔輪漲 ｜ 4 檔高出 ｜ 4 檔當沖",
      "analysis": "主軸偏向 其他、被動元件、封測。 和其他影片重複輪漲最多的是 超豐、佳必琪、矽格、良維、耿鼎。 高出辨識股集中在 聯亞、聯鈞。 當沖股則是 台半、強茂、聯電、頎邦，節奏偏快。",
      "tags": [
        "主軸 其他",
        "11 檔重複輪漲",
        "2 檔重複高出",
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq -0.16%、S&P 500 -0.10%、費半 -1.91%。美股科技鏈轉保守，對 其他、被動元件、封測 這組主軸會增加開高走低風險。",
          "signals": [
            "Nasdaq -0.16%",
            "費半 -1.91%",
            "電子偏保守"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 +0.91%、東京威力科創 +1.22%、Advantest -1.89%。日股科技股震盪，通常代表亞洲電子鏈對 其他、被動元件、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 +0.91%",
            "TEL +1.22%",
            "日股中性"
        ...
        "hidden": {
          "label": "蓋牌猜測",
          "summary": "若今天大盤延續 其他、被動元件、封測 輪動，蓋牌比較像 信邦、神達、鴻海。這幾檔沒有在這支影片直接講出來，但不是同族群補漲，就是在前兩支影片曾被反覆點過。",
          "signals": [
            "信邦：曾在 2026/06/01 列輪漲 / 曾在 2026/05/29 列輪漲",
            "神達：曾在 2026/06/01 列輪漲 / 曾在 2026/05/29 列輪漲",
            "鴻海：曾在 2026/06/01 列輪漲 / 曾在 2026/05/29 列輪漲"
          ]
        }
      }
    }
  ...
  "stocks": [
    {
      ...
      "name": "佳必琪",
      "bias": "3日共通",
      "gap": "2026/06/01、2026/05/29、2026/05/28",
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "佳必琪 在 2026/06/01、2026/05/29、2026/05/28 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "伺服器 / 車電",
      "note": "神達 在 2026/06/01、2026/05/29 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.139、40 日 %B 約 -0.169；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "騰輝 在 2026/06/01、2026/05/29 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "矽格 在 2026/06/01、2026/05/29、2026/05/28 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.993、40 日 %B 約 0.455；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 散熱 / 伺服器",
      "note": "奇鋐 在 2026/06/01、2026/05/29、2026/05/28 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.590、40 日 %B 約 0.366；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "CCL / PCB",
      "note": "台燿 在 2026/06/01、2026/05/29、2026/05/28 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/06/01、2026/05/29、2026/05/28 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.131、40 日 %B 約 0.280；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/06/01、2026/05/29、2026/05/28 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.560、40 日 %B 約 0.320；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "電子權值 / AI 伺服器",
      "note": "鴻海 在 2026/06/01、2026/05/29 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.001、40 日 %B 約 0.003；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "連接線組",
      "note": "信邦 在 2026/06/01、2026/05/29 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.605、40 日 %B 約 0.398；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 伺服器 / 顯卡",
      "note": "技嘉 在 2026/06/01、2026/05/29、2026/05/28 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.291、40 日 %B 約 0.217；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "線材 / AI 電源",
      "note": "良維 在 2026/06/01、2026/05/29、2026/05/28 這組影片裡被列為輪漲股，目前先依 TPEx 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "name": "超豐",
      "bias": "2日共通",
      "gap": "2026/05/29、2026/05/28",
      "foreign": "交叉輪漲",
      "volume": "封測",
      "note": "超豐 在 2026/05/29、2026/05/28 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.286、40 日 %B 約 0.196；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "待補產業",
      "note": "耿鼎 在 2026/05/29、2026/05/28 這組影片裡被列為輪漲股，目前先依 官方 整理資料列入觀察，等後續影片是否續點再決定排序。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
  ...
  "checklist": [
    "先看 2026/06/01 與前兩支影片的交叉輪漲股：佳必琪、矽格、奇鋐、台燿、勤誠、貿聯、技嘉、良維。",
    "高出股 南電、聯亞、聯鈞 要和輪漲股分開，不要混成主攻名單。",
    "當沖股 華邦、強茂、聯電 屬快節奏，不適合直接列成首選。",
    "今天盤前先看 貿聯、奇鋐、技嘉 是否續量。"
  ],
  "risks": [
    {
      "level": "high",
      "title": "影片基準已更新到 2026/06/01、2026/05/29、2026/05/28",
      "detail": "目前基準改用黃清照 YouTube 頻道 /videos 頁面排序，最新三支就是 2026/06/01、2026/05/29、2026/05/28。"
    },
    {
      "level": "medium",
      "title": "有出現三日共通輪漲股",
      "detail": "佳必琪、矽格、奇鋐、台燿、勤誠、貿聯、技嘉、良維 是目前最穩的 3 日共通輪漲股。"
    },
    {
      "level": "medium",
      "title": "高出股與當沖股要拆開處理",
      "detail": "南電、聯亞、聯鈞 偏高檔辨識；華邦、強茂、聯電 偏快節奏，和輪漲股不是同一層級。"
    }
  ],
  "bollingerRankings": [
    {
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/06/01 收盤",
      "summary": "技嘉 用 TWSE 官方日資料重算後，20 日 %B 約 0.291、40 日 %B 約 0.217；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.291",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/06/01 收盤",
      "summary": "矽格 用 TWSE 官方日資料重算後，20 日 %B 約 0.993、40 日 %B 約 0.455；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.993",
        "40日不過熱"
  ...
  "markovModel": {
    "currentState": "主線延續偏多",
    "confidence": 82,
    "takeaway": "2026/06/01 到 2026/05/28 三支影片交叉後，佳必琪、矽格、奇鋐、台燿、勤誠、貿聯、技嘉、良維 是目前最穩的 3 日共通輪漲股；南電、聯亞、聯鈞 則偏向高檔辨識。",
    "transitions": [
      {
        "label": "維持主線延續",
        "value": "82%"
    ...
    "drivers": [
      "2026/06/01 輪漲股是 緯創、光寶、佳必琪、神達、騰輝、矽格、奇鋐、台燿",
      "2026/05/29 對照下，可直接交叉出 佳必琪、神達、騰輝、矽格、奇鋐、台燿、勤誠、貿聯、鴻海、信邦、技嘉、良維",
      "2026/05/28 對照下，可直接交叉出 佳必琪、矽格、奇鋐、台燿、勤誠、貿聯、技嘉、良維"
    ]
  },
  "monteCarloScenarios": [
    {
      ...
      "name": "貿聯",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 1011 - 2161",
      "stopLoss": "3% 停損命中率 87%",
      "takeProfit": "8% 停利命中率 67%",
      "drawdown": "模擬最大回撤中位數 35.9%",
    ...
    },
    {
      ...
      "name": "奇鋐",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 1398 - 2514",
      "stopLoss": "3% 停損命中率 85%",
      "takeProfit": "8% 停利命中率 70%",
      "drawdown": "模擬最大回撤中位數 29.6%",
    ...
    },
    {
      ...
      "name": "技嘉",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 158 - 265",
      "stopLoss": "3% 停損命中率 85%",
      "takeProfit": "8% 停利命中率 70%",
      "drawdown": "模擬最大回撤中位數 26.8%",
      "note": "技嘉 屬於可以當第二層風險觀察的延續股。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
