const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.05.29.2200",
    "lastUpdated": "2026/05/29 22:00",
    "lastAutomationSync": "2026/05/29 22:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.58%、S&P 500 +0.45%、費半 +1.96%。美股科技鏈偏多，對 其他、封測、線纜補漲 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.58%",
            "費半 +1.96%",
            "電子偏多"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.58%、S&P 500 +0.45%、費半 +1.96%。美股科技鏈偏多，對 其他、被動元件、封測 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.58%",
            "費半 +1.96%",
            "電子偏多"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.58%、S&P 500 +0.45%、費半 +1.96%。美股科技鏈偏多，對 封測、其他、被動元件 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.58%",
            "費半 +1.96%",
            "電子偏多"
  ...
  "stocks": [
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/05/29、2026/05/28、2026/05/27 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.385、40 日 %B 約 0.314；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 伺服器 / 顯卡",
      "note": "技嘉 在 2026/05/29、2026/05/28 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.871、40 日 %B 約 0.524；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
  ...
  "monteCarloScenarios": [
    {
      ...
      "name": "健鼎",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 285 - 455",
      "stopLoss": "3% 停損命中率 87%",
      "takeProfit": "8% 停利命中率 60%",
      "drawdown": "模擬最大回撤中位數 26.7%",
    ...
    },
    {
      ...
      "name": "勤誠",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 626 - 1064",
      "stopLoss": "3% 停損命中率 86%",
      "takeProfit": "8% 停利命中率 61%",
      "drawdown": "模擬最大回撤中位數 29.0%",
