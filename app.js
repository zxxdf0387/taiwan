const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.08.0900",
    "lastUpdated": "2026/06/08 09:00",
    "lastAutomationSync": "2026/06/08 09:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -3.21%、東京威力科創 -5.79%、Advantest -4.97%。日股科技股轉弱，通常代表亞洲電子鏈對 其他、電源、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -3.21%",
            "TEL -5.79%",
            "日股轉弱"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI -5.01%、Samsung -6.53%、SK Hynix -4.20%。韓股電子權值轉弱，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI -5.01%",
            "Samsung -6.53%",
            "Hynix -4.20%"
    ...
    },
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -3.21%、東京威力科創 -5.79%、Advantest -4.97%。日股科技股轉弱，通常代表亞洲電子鏈對 其他、封測、電源 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -3.21%",
            "TEL -5.79%",
            "日股轉弱"
  ...
  "stocks": [
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI 機殼",
      "note": "勤誠 在 2026/06/05、2026/06/04、2026/06/03 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.131、40 日 %B 約 0.251；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
  ...
  "monteCarloScenarios": [
    ...
    },
    {
      ...
      "name": "智邦",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 890 - 1885",
      "stopLoss": "3% 停損命中率 86%",
      "takeProfit": "8% 停利命中率 65%",
      "drawdown": "模擬最大回撤中位數 34.0%",
    ...
    },
    {
      ...
      "name": "矽格",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 105 - 178",
      "stopLoss": "3% 停損命中率 88%",
      "takeProfit": "8% 停利命中率 61%",
      "drawdown": "模擬最大回撤中位數 27.7%",
