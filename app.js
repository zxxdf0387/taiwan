const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.02.2200",
    "lastUpdated": "2026/06/02 22:00",
    "lastAutomationSync": "2026/06/02 22:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.02%、S&P 500 -0.10%、費半 +3.83%。美股科技鏈偏多，對 其他、AI PC、伺服器 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.02%",
            "費半 +3.83%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.30%、東京威力科創 +1.23%、Advantest +2.51%。日股科技股續強，通常代表亞洲電子鏈對 其他、AI PC、伺服器 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.30%",
            "TEL +1.23%",
            "日股偏多"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI +0.15%、Samsung +3.30%、SK Hynix -0.13%。韓股電子權值偏多，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI +0.15%",
            "Samsung +3.30%",
            "Hynix -0.13%"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.02%、S&P 500 -0.10%、費半 +3.83%。美股科技鏈偏多，對 其他、AI PC、電源 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.02%",
            "費半 +3.83%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.30%、東京威力科創 +1.23%、Advantest +2.51%。日股科技股續強，通常代表亞洲電子鏈對 其他、AI PC、電源 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.30%",
            "TEL +1.23%",
            "日股偏多"
    ...
    },
    {
      ...
      "marketLinks": {
        "us": {
          "label": "美股分析",
          "summary": "Nasdaq +0.02%、S&P 500 -0.10%、費半 +3.83%。美股科技鏈偏多，對 其他、封測、線纜補漲 這組主軸有順風。",
          "signals": [
            "Nasdaq +0.02%",
            "費半 +3.83%",
            "電子偏多"
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -0.30%、東京威力科創 +1.23%、Advantest +2.51%。日股科技股續強，通常代表亞洲電子鏈對 其他、封測、線纜補漲 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -0.30%",
            "TEL +1.23%",
            "日股偏多"
  ...
  "stocks": [
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "AI PC / 伺服器",
      "note": "緯創 在 2026/06/02、2026/06/01 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 -0.000、40 日 %B 約 0.045；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "2日共通",
          "type": "positive"
    ...
    },
    {
      ...
      "foreign": "交叉輪漲",
      "volume": "高速連接 / AI 線束",
      "note": "貿聯 在 2026/06/02、2026/06/01、2026/05/29 都被列為輪漲股，TWSE 官方日資料重算後，20 日 %B 約 0.560、40 日 %B 約 0.320；這檔在目前交叉後的角色辨識度仍然夠高。",
      "signals": [
        {
          "text": "3日共通",
          "type": "positive"
  ...
  "bollingerRankings": [
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/06/02 收盤",
      "summary": "貿聯 用 TWSE 官方日資料重算後，20 日 %B 約 0.560、40 日 %B 約 0.320；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "3日共通",
        "20日 %B 0.560",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/06/02 收盤",
      "summary": "奇鋐 用 TWSE 官方日資料重算後，20 日 %B 約 0.590、40 日 %B 約 0.348；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "2日共通",
        "20日 %B 0.590",
        "40日不過熱"
    ...
    },
    {
      ...
      "verdict": "交叉延續股",
      "asOf": "截至 2026/06/02 收盤",
      "summary": "超豐 用 TWSE 官方日資料重算後，20 日 %B 約 0.286、40 日 %B 約 0.196；又是最近三支影片交叉後的重複輪漲股。",
      "signals": [
        "2日共通",
        "20日 %B 0.286",
        "40日不過熱"
  ...
  "monteCarloScenarios": [
    {
      ...
      "name": "信邦",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 208 - 295",
      "stopLoss": "3% 停損命中率 80%",
      "takeProfit": "8% 停利命中率 61%",
      "drawdown": "模擬最大回撤中位數 18.3%",
    ...
    },
    {
      ...
      "name": "貿聯",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 1091 - 2109",
      "stopLoss": "3% 停損命中率 89%",
      "takeProfit": "8% 停利命中率 66%",
      "drawdown": "模擬最大回撤中位數 36.0%",
    ...
    },
    {
      ...
      "name": "勤誠",
      "verdict": "第二梯隊觀察",
      "range": "20 日模擬區間 577 - 944",
      "stopLoss": "3% 停損命中率 91%",
      "takeProfit": "8% 停利命中率 60%",
      "drawdown": "模擬最大回撤中位數 30.3%",
