const appState = {
  "liveQuotes": {},
  "updateMeta": {
    "version": "2026.06.06.0900",
    "lastUpdated": "2026/06/06 09:00",
    "lastAutomationSync": "2026/06/06 09:00",
  ...
  "headlines": [
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -1.36%、東京威力科創 -6.61%、Advantest -4.99%。日股科技股轉弱，通常代表亞洲電子鏈對 其他、電源、封測 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -1.36%",
            "TEL -6.61%",
            "日股轉弱"
        ...
        "kr": {
          "label": "韓股分析",
          "summary": "KOSPI -1.84%、Samsung -6.40%、SK Hynix -9.92%。韓股電子權值轉弱，若韓股記憶體與權值一起強，台股電子主線通常比較容易延續。",
          "signals": [
            "KOSPI -1.84%",
            "Samsung -6.40%",
            "Hynix -9.92%"
    ...
    },
    {
      ...
      "marketLinks": {
        ...
        "jp": {
          "label": "日股分析",
          "summary": "日經 225 -1.36%、東京威力科創 -6.61%、Advantest -4.99%。日股科技股轉弱，通常代表亞洲電子鏈對 其他、封測、電源 的隔日情緒有沒有延續。",
          "signals": [
            "日經 -1.36%",
            "TEL -6.61%",
            "日股轉弱"
  ...
  "monteCarloScenarios": [
    {
      ...
      "name": "貿聯",
      "verdict": "模型最平衡",
      "range": "20 日模擬區間 1083 - 2118",
      "stopLoss": "3% 停損命中率 91%",
      "takeProfit": "8% 停利命中率 66%",
      "drawdown": "模擬最大回撤中位數 35.8%",
    ...
    },
    {
      ...
      "name": "智邦",
      "verdict": "延續機率高",
      "range": "20 日模擬區間 899 - 1746",
      "stopLoss": "3% 停損命中率 92%",
      "takeProfit": "8% 停利命中率 63%",
      "drawdown": "模擬最大回撤中位數 37.6%",
